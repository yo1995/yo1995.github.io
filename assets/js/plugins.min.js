window.Modernizr = function(e, t, i) {
    ...
    function l(e, t, n) {
        for (var o in e) {
            var r = t[e[o]];
            if (r !== i)
                return n === !1 ? e[o] : a(r, "function") ? r.bind(n || t) : r
        }
        return !1
    }
    function p(e, t, i) {
        ...
        return a(t, "string") || a(t, "undefined") ? s(o, t) : (o = (e + " " + k.join(n + " ") + n).split(" "),
        l(o, t, i))
    }
    function d() {
        h.input = function(i) {
        ...
        h.inputtypes = function(e) {
            for (var n, o, a, r = 0, s = e.length; s > r; r++)
                b.setAttribute("type", o = e[r]),
                n = "text" !== b.type,
                n && (b.value = x,
                b.style.cssText = "position:absolute;visibility:hidden;",
                /^range$/.test(o) && b.style.WebkitAppearance !== i ? (g.appendChild(b),
                a = t.defaultView,
                n = a.getComputedStyle && "textfield" !== a.getComputedStyle(b, null).WebkitAppearance && 0 !== b.offsetHeight,
                g.removeChild(b)) : /^(search|tel)$/.test(o) || (n = /^(url|email)$/.test(o) ? b.checkValidity && b.checkValidity() === !1 : b.value != x)),
                z[e[r]] = !!n;
            return z
        }("search tel url email datetime date month week time datetime-local number range color".split(" "))
    }
    var c, u, f = "2.8.3", h = {}, m = !0, g = t.documentElement, v = "modernizr", y = t.createElement(v), w = y.style, b = t.createElement("input"), x = ":)", S = {}.toString, T = " -webkit- -moz- -o- -ms- ".split(" "), C = "Webkit Moz O ms", E = C.split(" "), k = C.toLowerCase().split(" "), P = {
        svg: "http://www.w3.org/2000/svg"
    }, I = {}, z = {}, M = {}, L = [], A = L.slice, O = function(e, i, n, o) {
        var a, r, s, l, p = t.createElement("div"), d = t.body, c = d || t.createElement("body");
        if (parseInt(n, 10))
            for (; n--; )
        ...
        g.appendChild(c)),
        r = i(p, e),
        d ? p.parentNode.removeChild(p) : (c.parentNode.removeChild(c),
        g.style.overflow = l),
        !!r
    }, _ = function(t) {
        ...
        function e(e, o) {
            ...
            e = "on" + e;
            var r = e in o;
            return r || (o.setAttribute || (o = t.createElement("div")),
            o.setAttribute && o.removeAttribute && (o.setAttribute(e, ""),
            r = a(o[e], "function"),
            a(o[e], "undefined") || (o[e] = i),
            o.removeAttribute(e))),
            o = null,
            r
        }
    ...
    I.rgba = function() {
        ...
        r(w.backgroundColor, "rgba")
    }
    ,
    I.hsla = function() {
        return n("background-color:hsla(120,40%,100%,.5)"),
        r(w.backgroundColor, "rgba") || r(w.backgroundColor, "hsla")
    }
    ,
    ...
    I.cssgradients = function() {
        ...
        return n((e + "-webkit- ".split(" ").join(t + e) + T.join(i + e)).slice(0, -e.length)),
        r(w.backgroundImage, "gradient")
    }
    ,
    ...
    function(e, t) {
        ...
        function a(e, i, n) {
            ...
            n || (n = o(i));
            var a;
            return a = n.cache[e] ? n.cache[e].cloneNode() : h.test(e) ? (n.cache[e] = n.createElem(e)).cloneNode() : n.createElem(e),
            !a.canHaveChildren || f.test(e) || a.tagUrn ? a : n.frag.appendChild(a)
        }
        function r(e, i) {
            if (e || (e = t),
            d)
            ...
            i = i || o(e);
            for (var a = i.frag.cloneNode(), r = 0, s = n(), l = s.length; l > r; r++)
                a.createElement(s[r]);
            return a
        }
        function s(e, t) {
        ...
        function l(e) {
            e || (e = t);
            var n = o(e);
            return !y.shivCSS || p || n.hasCSS || (n.hasCSS = !!i(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),
            d || s(e, n),
            e
        }
        var p, d, c = "3.7.0", u = e.html5 || {}, f = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, h = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, m = "_html5shiv", g = 0, v = {};
        !function() {
            try {
    ...
    ,
    g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (m ? " js " + L.join(" ") : ""),
    h
}(this, this.document),
function(e) {
    function t() {
        ...
        !t && e.support.boxModel || (i = "CSS1Compat" === t ? d : l.body,
        n = {
            ...
            a = a || i(); n > l; l++)
                if (e.contains(d, r[l][0])) {
                    var p, c, u, f = e(r[l]), h = {
                        height: f.height(),
                        width: f.width()
                    }, m = f.offset(), g = f.data("inview");
                    if (!a || !o)
                        return;
                    m.top + h.height > a.top && m.top < a.top + o.height && m.left + h.width > a.left && m.left < a.left + o.width ? (p = a.left > m.left ? "right" : a.left + o.width < m.left + h.width ? "left" : "both",
                    c = a.top > m.top ? "bottom" : a.top + o.height < m.top + h.height ? "top" : "both",
                    u = p + "-" + c,
                    g && g === u || f.data("inview", u).trigger("inview", [!0, p, c])) : g && f.data("inview", !1).trigger("inview", [!1])
                }
    }
    var o, a, r, s = {}, l = document, p = window, d = l.documentElement, c = e.expando;
    e.event.special.inview = {
        ...
        remove: function(t) {
            ...
            e.isEmptyObject(s) && (clearInterval(r),
            r = null)
        }
    },
    ...
    e.fn.countTo = function(t) {
        ...
        return e(this).each(function() {
            function o() {
                ...
                r >= i && (clearInterval(l),
                s = t.to,
                "function" == typeof t.onComplete && t.onComplete.call(a, s))
            }
            var a = this
              , r = 0
              , s = t.from
                    ...
                    for (var r = n.call(arguments, 1), s = 0, l = this.length; l > s; s++) {
                        ...
                        if (d)
                            if (e.isFunction(d[o]) && "_" !== o.charAt(0)) {
                                ...
                                a("no such method '" + o + "' for " + t + " instance");
                        else
                            a("cannot call methods on " + t + " prior to initialization; attempted to call '" + o + "'")
                    }
                    return this
                }
...
function() {
    ...
    n.addListener = function(e, i) {
        var n, o = this.getListenersAsObject(e), a = "object" == typeof i;
        for (n in o)
            o.hasOwnProperty(n) && -1 === t(o[n], i) && o[n].push(a ? i : {
                listener: i,
                once: !1
            });
        return this
    ...
    n.manipulateListeners = function(e, t, i) {
        var n, o, a = e ? this.removeListener : this.addListener, r = e ? this.removeListeners : this.addListeners;
        if ("object" != typeof t || t instanceof RegExp)
            for (n = i.length; n--; )
                a.call(this, t, i[n]);
        else
            for (n in t)
                t.hasOwnProperty(n) && (o = t[n]) && ("function" == typeof o ? a.call(this, n, o) : r.call(this, n, o));
        return this
    }
    ,
    ...
    function a(t) {
        ...
        function a(e) {
            ...
            e && "object" == typeof e && e.nodeType) {
                ...
                var E = i(t.height);
                return E !== !1 && (a.height = E + (T ? 0 : y + S)),
                a.innerWidth = a.width - (v + x),
                a.innerHeight = a.height - (y + S),
                a.outerWidth = a.width + w,
                a.outerHeight = a.height + b,
                a
            }
        }
        function l(t, i) {
            ...
            var n = t.style
              ...
              , a = t.runtimeStyle
              , r = a && a.left;
            return r && (a.left = t.currentStyle.left),
            n.left = i,
            i = n.pixelLeft,
            n.left = o,
            r && (a.left = r),
...
function(e) {
    ...
    function o(o) {
        return "complete" === a.readyState ? n() : (o.bind(a, "DOMContentLoaded", i),
        o.bind(a, "readystatechange", i),
        o.bind(e, "load", i)),
        t
    }
    var a = e.document
    ...
    n.filterFindElements = function(e, t) {
        ...
        for (var o = [], a = 0, r = e.length; r > a; a++) {
            ...
            if (n.isElement(s))
                if (t) {
                    i(s, t) && o.push(s);
                    for (var l = s.querySelectorAll(t), p = 0, d = l.length; d > p; p++)
                        o.push(l[p])
                } else
                    o.push(s)
        }
    ...
    return n.htmlInit = function(i, o) {
        t(function() {
            for (var t = n.toDashed(o), r = document.querySelectorAll(".js-" + t), s = "data-" + t + "-options", l = 0, p = r.length; p > l; l++) {
                var d, c = r[l], u = c.getAttribute(s);
                try {
                    d = u && JSON.parse(u)
                } catch (f) {
...
function(e, t) {
    ...
    o.extend(r.prototype, t.prototype),
    ...
    r.prototype._transitionTo = function(e, t) {
        ...
        var s = e - i
          , l = t - n
          , p = {};
        p.transform = this.getTranslate(s, l),
        this.transition({
            to: p,
            onTransitionEnd: {
    ...
    r.prototype.getTranslate = function(e, t) {
        ...
        t = i.isOriginTop ? t : -t,
        f ? "translate3d(" + e + "px, " + t + "px, 0)" : "translate(" + e + "px, " + t + "px)"
    }
    ,
...
function(e, t) {
    ...
    function r(e, t) {
        ...
        if (!i)
            return void (s && s.error("Bad element for " + this.constructor.namespace + ": " + (i || e)));
        this.element = i,
    ...
    r.prototype._getMeasurement = function(e, t) {
        ...
        a ? ("string" == typeof a ? i = this.element.querySelector(a) : o.isElement(a) && (i = a),
        this[e] = i ? n(i)[t] : a) : this[e] = 0
    }
    ,
    ...
    r.prototype._layoutItems = function(e, t) {
        ...
        e && e.length) {
            for (var i = [], n = 0, o = e.length; o > n; n++) {
                ...
                r.item = a,
                r.isInstant = t || a.isLayoutInstant,
                i.push(r)
            }
    ...
    ,
    r.prototype._getContainerSize = p,
    r.prototype._setContainerMeasure = function(e, t) {
        if (void 0 !== e) {
            var i = this.size;
    ...
    ,
    r.prototype._manageStamp = p,
    r.prototype._getElementOffset = function(e) {
...
function(e, t) {
    ...
    n.prototype._getItemLayoutPosition = function(e) {
        ...
        for (var a = this._getColGroup(o), r = Math.min.apply(Math, a), s = i.indexOf(a, r), l = {
            ...
            y: r
        }, p = r + e.size.outerHeight, d = this.cols + 1 - a.length, c = 0; d > c; c++)
            this.colYs[s + c] = p;
        return l
    }
    ,
    ...
    n.prototype._manageStamp = function(e) {
        ...
        for (var l = (this.options.isOriginTop ? n.top : n.bottom) + i.outerHeight, p = r; s >= p; p++)
    ...
    u.prototype._filter = function(e) {
        ...
        for (var i = [], n = [], o = [], a = this._getFilterTest(t), r = 0, s = e.length; s > r; r++) {
            ...
            if (!l.isIgnored) {
                var p = a(l);
                p && i.push(l),
                p && l.isHidden ? n.push(l) : p || l.isHidden || o.push(l)
            }
        }
        return {
            matches: i,
...
!function(e) {
    ...
    var o, a, r = function() {
        if (!e.getComputedStyle)
            return !1;
        var t, i = document.createElement("p"), n = {
        ...
        for (var o in n)
            "undefined" != typeof i.style[o] && (i.style[o] = "translate3d(1px,1px,1px)",
            t = e.getComputedStyle(i).getPropertyValue(n[o]));
        return (document.body || document.documentElement).removeChild(i),
        "undefined" != typeof t && t.length > 0 && "none" !== t
    }(), s = navigator.userAgent.toLowerCase().indexOf("android") > -1, l = /iPad|iPhone|iPod/.test(navigator.userAgent) && !e.MSStream, p = !!e.opera, d = /Edge\/\d+/.test(navigator.userAgent), c = /Trident.*rv[ :]*11\./.test(navigator.userAgent), u = !!Function("/*@cc_on return document.documentMode===10@*/")(), f = document.all && !e.atob;
    t();
    var h = []
      , m = function() {
        function e(e, i) {
            ...
            s && o.options.noAdnroid || l && o.options.noIos || (o.options.speed = Math.min(2, Math.max(-1, parseFloat(o.options.speed))),
            o.instanceID = t++,
            o.image = {
    ...
    m.prototype.init = function() {
        ...
        f && (n.backgroundAttachment = "fixed"),
    ...
    m.prototype.coverImage = function() {
        ...
        if (e.image.width && e.image.height) {
            var t = e.image.$container.getBoundingClientRect()
              ...
              , m = 0;
            d && (c = p * (n + a) / 2,
            (0 > p || p > 1) && (c = p * Math.max(n, a) / 2),
            0 > p || p > 1 ? f = Math.max(n, a) + 2 * Math.abs(c) : f += Math.abs(a - n) * (1 - p)),
            u = f * s / l,
            i > u && (u = i,
            f = u * l / s),
            e.bgPosVerticalCenter = 0,
            !(d && a > f) || r && e.options.enableTransform || (e.bgPosVerticalCenter = (a - f) / 2,
            f = a),
            d ? (h = o + (i - u) / 2,
            m = (a - f) / 2) : (h = (i - u) / 2,
            m = (n - f) / 2),
            e.parentWithTransform && (h -= o),
            e.parallaxScrollDistance = c,
            e.css(e.image.$item, {
                width: u + "px",
                height: f + "px",
                marginLeft: h + "px",
        ...
        if (t.image.width && t.image.height) {
            ...
            if (!p) {
                var d = Math.max(0, n)
                  ...
                  , v = 1 - 2 * (a - n) / (a + s)
                  , y = 1;
                if (a > s ? y = 1 - (u || h) / s : a >= c ? y = c / a : a >= m && (y = m / a),
                ...
                "scale" === t.options.type || "scale-opacity" === t.options.type) {
                    var w = 1;
                    t.options.speed < 0 ? w -= t.options.speed * y : w += t.options.speed * (1 - y),
                    l.transform = "scale(" + w + ") translate3d(0, 0, 0)"
                }
                if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                    var b = t.parallaxScrollDistance * v;
                    r && t.options.enableTransform ? (t.parentWithTransform && (b -= n),
                    l.transform = "translate3d(0, " + b + "px, 0)") : (t.bgPosVerticalCenter && (b += t.bgPosVerticalCenter),
                    l.backgroundPosition = "50% " + b + "px"),
                    l.position = f ? "absolute" : "fixed"
                }
    ...
    i(e, "scroll", n),
    i(e, "resize", n),
    i(e, "orientationchange", n),
    i(e, "load", n);
    var g = function(e) {
        ("object" == typeof HTMLElement ? e instanceof HTMLElement : e && "object" == typeof e && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName) && (e = [e]);
        var t, i = arguments[1], n = Array.prototype.slice.call(arguments, 2), o = e.length, a = 0;
        for (a; o > a; a++)
            if ("object" == typeof i || "undefined" == typeof i ? e[a].jarallax || (e[a].jarallax = new m(e[a],i)) : e[a].jarallax && (t = e[a].jarallax[i].apply(e[a].jarallax, n)),
            "undefined" != typeof t)
                return t;
        return e
    };
...
!function(e) {
    ...
    var n = function() {
        function e(e, n) {
            ...
            o.options = t({}, o.options_default, n),
    ...
    n.prototype.getImageURL = function(e) {
        ...
        if ("youtube" === t.type) {
            var i = ["maxresdefault", "sddefault", "hqdefault", "0"]
              ...
              , o = new Image;
            o.onload = function() {
                120 !== (this.naturalWidth || this.width) || n === i.length - 1 ? (t.videoImage = "https://img.youtube.com/vi/" + t.videoID + "/" + i[n] + ".jpg",
                e(t.videoImage)) : (n++,
    ...
    n.prototype.getIframe = function(t) {
        ...
        return i.$iframe ? void t(i.$iframe) : void i.onAPIready(function() {
            ...
            "youtube" === i.type) {
                ...
                i.playerOptions.width = e.innerWidth || document.documentElement.clientWidth,
                ...
                i.playerOptions.events = {
                    ...
                    onStateChange: function(e) {
                        i.options.loop && e.data === YT.PlayerState.ENDED && e.target.playVideo(),
                ...
                a && (i.$iframe = document.getElementById(i.playerID))
            }
            "vimeo" === i.type && (i.playerOptions = "",
            ...
            document.body.appendChild(n)),
            i.player = i.player || $f(i.$iframe),
            i.player.addEvent("ready", function(e) {
                i.player.api("setVolume", i.options.mute ? 0 : 100),
                i.options.autoplay && i.play();
                var t;
    ...
    n.prototype.loadAPI = function() {
        ...
        if (!o || !a) {
            var i = "";
            "youtube" !== t.type || o || (o = 1,
            i = "//www.youtube.com/iframe_api"),
            "vimeo" !== t.type || a || (a = 1,
            i = "//f.vimeocdn.com/js/froogaloop2.min.js"),
    ...
    n.prototype.onAPIready = function(t) {
        ...
        "vimeo" === i.type)
            if ("undefined" != typeof $f || s)
                "undefined" != typeof $f ? t() : p.done(function() {
                    t()
                });
            else {
                s = 1;
    ...
    if ("undefined" != typeof jarallax) {
        ...
        e.prototype.initImg = function() {
            ...
            e.options.videoSrc) {
                ...
                return t.isValid() && (e.image.useImgTag = !0,
                t.on("ready", function() {
                    var i = e.onScroll;
                    e.onScroll = function() {
                        i.apply(e),
                        e.isVisible() ? t.play() : t.pause()
                    }
                }),
                t.on("started", function() {
                    e.image.$default_item = e.image.$item,
                    e.image.$item = e.$video,
                    e.image.width = e.imgWidth = 1280,
                    e.image.height = e.imgHeight = 720,
                    e.coverImage(),
                    e.clipContainer(),
                    e.onScroll(),
...
function(e, t, i, n) {
    ...
    i.extend(s, {
        ...
        open: function(e, t) {
            ...
            !1 !== s.close(!0)) ? (i.isArray(e) || (e = c(e) ? i(e).get() : [e]),
            i.each(e, function(o, a) {
                ...
                i.metadata && i.extend(!0, g, a.metadata())) : g = a),
                r = t.href || g.href || (u(a) ? a : null),
                l = t.title !== n ? t.title : g.title || "",
                p = t.content || g.content,
                d = p ? "html" : t.type || g.type,
                !d && g.isDom && (d = a.data("fancybox-type"),
                d || (f = a.prop("class").match(/fancybox\.(\w+)/),
                d = f ? f[1] : null)),
                u(r) && (d || (s.isImage(r) ? d = "image" : s.isSWF(r) ? d = "swf" : "#" === r.charAt(0) ? d = "inline" : u(a) && (d = "html",
                p = a)),
                "ajax" === d && (h = r.split(/\s+/, 2),
                r = h.shift(),
                m = h.shift())),
                p || ("inline" === d ? r ? p = i(u(r) ? r.replace(/.*(?=#[^\s]+$)/, "") : r) : g.isDom && (p = a) : "html" === d ? p = r : d || r || !g.isDom || (d = "inline",
                p = a)),
                i.extend(g, {
                    href: r,
                    type: d,
            ...
            t.keys !== n && (s.opts.keys = t.keys ? i.extend({}, s.defaults.keys, t.keys) : !1),
            s.group = e,
        ...
        close: function(e) {
            ...
            s.isActive && (s.isOpen && e !== !0 ? (s.isOpen = s.isOpened = !1,
            s.isClosing = !0,
        ...
        update: function(e) {
            ...
            i && (clearTimeout(p),
            p = null),
            s.isOpen && !p && (p = setTimeout(function() {
                var n = s.current;
        ...
        bindEvents: function() {
            ...
            e = t.keys,
            e && r.bind("keydown.fb", function(o) {
            ...
            i.fn.mousewheel && t.mouseWheel && s.wrap.bind("mousewheel.fb", function(e, n, o, a) {
                for (var r = e.target || null, l = i(r), p = !1; l.length && !(p || l.is(".fancybox-skin") || l.is(".fancybox-wrap")); )
                    p = h(l[0]),
                    l = i(l).parent();
                0 === n || p || s.group.length > 1 && !t.canShrink && (a > 0 || o > 0 ? s.prev(a > 0 ? "down" : "left") : (0 > a || 0 > o) && s.next(0 > a ? "up" : "right"),
                e.preventDefault())
            }))
        },
        ...
        _afterLoad: function() {
            var e, t, n, o, a, r, l = s.coming, p = s.current, d = "fancybox-placeholder";
            if (s.hideLoading(),
            l && s.isActive !== !1) {
                if (!1 === s.trigger("afterLoad", l, p))
                    return l.wrap.stop(!0).trigger("onReset").remove(),
                    void (s.coming = null);
                switch (p && (s.trigger("beforeChange", p),
                p.wrap.stop(!0).removeClass("fancybox-opened").find(".fancybox-item, .fancybox-nav").remove()),
                s.unbindEvents(),
                e = l,
                t = l.content,
                n = l.type,
                ...
                case "ajax":
                case "html":
                    e.selector ? t = i("<div>").html(t).find(e.selector) : c(t) && (t.data(d) || t.data(d, i('<div class="' + d + '"></div>').insertAfter(t).hide()),
                    t = t.show().detach(),
                ...
                s.coming = null,
                s.bindEvents(),
                s.isOpened ? p.prevMethod && s.transitions[p.prevMethod]() : i(".fancybox-wrap").not(e.wrap).stop(!0).trigger("onReset").remove(),
                s.transitions[s.isOpened ? e.nextMethod : e.openMethod](),
                s._preloadImages()
            }
        },
        _setDimension: function() {
            var e, t, n, o, a, r, l, p, d, c, u, h, v, y, w, b = s.getViewport(), x = 0, S = !1, T = !1, C = s.wrap, E = s.skin, k = s.inner, P = s.current, I = P.width, z = P.height, M = P.minWidth, L = P.minHeight, A = P.maxWidth, O = P.maxHeight, _ = P.scrolling, D = P.scrollOutside ? P.scrollbarWidth : 0, H = P.margin, N = m(H[1] + H[3]), W = m(H[0] + H[2]);
            if (C.add(E).add(k).width("auto").height("auto").removeClass("fancybox-tmp"),
            e = m(E.outerWidth(!0) - E.width()),
            t = m(E.outerHeight(!0) - E.height()),
            n = N + e,
            o = W + t,
            a = f(I) ? (b.w - n) * m(I) / 100 : I,
            r = f(z) ? (b.h - o) * m(z) / 100 : z,
            "iframe" === P.type) {
                if (y = P.content,
                P.autoHeight && 1 === y.data("ready"))
                    try {
                        y[0].contentWindow.document.location && (k.width(a).height(9999),
                        w = y.contents().find("body"),
                        D && w.css("overflow-x", "hidden"),
                        r = w.outerHeight(!0))
                    } catch (B) {}
            } else
                (P.autoWidth || P.autoHeight) && (k.addClass("fancybox-tmp"),
                P.autoWidth || k.width(a),
                P.autoHeight || k.height(r),
                P.autoWidth && (a = k.width()),
                P.autoHeight && (r = k.height()),
            ...
            l = A,
            p = O,
            P.fitToView && (A = Math.min(b.w - n, A),
            O = Math.min(b.h - o, O)),
            h = b.w - N,
            v = b.h - W,
            P.aspectRatio ? (I > A && (I = A,
            z = m(I / d)),
            z > O && (z = O,
            I = m(z * d)),
            M > I && (I = M,
            z = m(I / d)),
            L > z && (z = L,
            I = m(z * d))) : (I = Math.max(M, Math.min(I, A)),
            P.autoHeight && "iframe" !== P.type && (k.width(I),
            z = k.height()),
            z = Math.max(L, Math.min(z, O))),
            P.fitToView)
                if (k.width(I).height(z),
                C.width(I + e),
                c = C.width(),
                u = C.height(),
                P.aspectRatio)
                    for (; (c > h || u > v) && I > M && z > L && !(x++ > 19); )
                        z = Math.max(L, Math.min(O, z - 10)),
                        I = m(z * d),
                        M > I && (I = M,
                        z = m(I / d)),
                        I > A && (I = A,
                    ...
                    I = Math.max(M, Math.min(I, I - (c - h))),
                    z = Math.max(L, Math.min(z, z - (u - v)));
            D && "auto" === _ && r > z && h > I + e + D && (I += D),
            k.width(I).height(z),
            C.width(I + e),
            c = C.width(),
            u = C.height(),
            S = (c > h || u > v) && I > M && z > L,
            T = P.aspectRatio ? l > I && p > z && a > I && r > z : (l > I || p > z) && (a > I || r > z),
            i.extend(P, {
                dim: {
                    width: g(c),
                    height: g(u)
    ...
    s.transitions = {
        getOrigPosition: function() {
            ...
            a = i.outerHeight())) : (n.top = p.y + (p.h - a) * e.topRatio,
            n.left = p.x + (p.w - o) * e.leftRatio),
            ("fixed" === s.wrap.css("position") || e.locked) && (n.top -= p.y,
            n.left -= p.x),
            n = {
        ...
        step: function(e, t) {
            var i, n, o, a = t.prop, r = s.current, l = r.wrapSpace, p = r.skinSpace;
            "width" !== a && "height" !== a || (i = t.end === t.start ? 1 : (e - t.start) / (t.end - t.start),
            s.isClosing && (i = 1 - i),
            n = "width" === a ? r.wPadding : r.hPadding,
            o = e - n,
            s.skin[a](m("width" === a ? o : o - l * i)),
            s.inner[a](m("width" === a ? o : o - l * i - p * i)))
        },
        zoomIn: function() {
            var e = s.current
              , t = e.pos
        ...
        changeIn: function() {
            ...
            "down" === a || "right" === a ? (n[e] = g(m(n[e]) - r),
            o[e] = "+=" + r + "px") : (n[e] = g(m(n[e]) + r),
            o[e] = "-=" + r + "px")),
        ...
        changeOut: function() {
            var e = s.previous
              ...
              , o = s.direction
              , a = 200;
            "elastic" === t && (n["down" === o || "up" === o ? "top" : "left"] = ("up" === o || "left" === o ? "-" : "+") + "=" + a + "px"),
            e.wrap.animate(n, {
    ...
    s.helpers.overlay = {
        ...
        open: function(e) {
            ...
            e.closeClick && this.overlay.bind("click.overlay", function(e) {
                return i(e.target).hasClass("fancybox-overlay") ? (s.isActive ? s.close() : t.close(),
                !1) : void 0
            }),
        ...
        onReady: function(e, t) {
            ...
            n || this.create(e),
            e.locked && this.fixed && t.fixed && (n || (this.margin = r.height() > a.height() ? i("html").css("margin-right").replace("px", "") : !1),
    ...
    i.fn.fancybox = function(e) {
        var t, n = i(this), o = this.selector || "", a = function(a) {
            var r, l, p = i(this).blur(), d = t;
            a.ctrlKey || a.altKey || a.shiftKey || a.metaKey || p.is(".fancybox-wrap") || (r = e.groupAttr || "data-fancybox-group",
            l = p.attr(r),
            l || (r = "rel",
            l = p.get(0)[r]),
            l && "" !== l && "nofollow" !== l && (p = o.length ? i(o) : n,
            p = p.filter("[" + r + '="' + l + '"]'),
            d = p.index(this)),
            e.index = d,
            s.open(p, e) !== !1 && a.preventDefault())
        };
        return e = e || {},
        t = e.index || 0,
        o && e.live !== !1 ? r.undelegate(o, "click.fb-start").delegate(o + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", a) : n.unbind("click.fb-start").bind("click.fb-start", a),
...
!function(e) {
    ...
    e.flexslider = function(i, n) {
        ...
        var a, r = o.vars.namespace, s = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, l = ("ontouchstart"in window || s || window.DocumentTouch && document instanceof DocumentTouch) && o.vars.touch, p = "click touchend MSPointerUp keyup", d = "", c = "vertical" === o.vars.direction, u = o.vars.reverse, f = o.vars.itemWidth > 0, h = "fade" === o.vars.animation, m = "" !== o.vars.asNavFor, g = {};
        ...
        g = {
            init: function() {
                ...
                o.prop = c ? "top" : "marginLeft",
                o.args = {},
                o.manualPause = !1,
                o.stopped = !1,
                o.started = !1,
                o.startTimeout = null,
                o.transitions = !o.vars.video && !h && o.vars.useCSS && function() {
                    var e = document.createElement("div")
                      , t = ["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"];
                    for (var i in t)
                        if (void 0 !== e.style[t[i]])
                            return o.pfx = t[i].replace("Perspective", "").toLowerCase(),
                ...
                o.vars.keyboard && (1 === e(o.containerSelector).length || o.vars.multipleKeyboard) && e(document).bind("keyup", function(e) {
                    var t = e.keyCode;
                ...
                (!h || h && o.vars.smoothHeight) && e(window).bind("resize orientationchange focus", g.resize),
                ...
                setup: function() {
                    ...
                    o.slides.each(function() {
                        ...
                        t.addEventListener("MSGestureTap", function(t) {
                            ...
                            var i = e(this)
                              , n = i.index();
                            e(o.vars.asNavFor).data("flexslider").animating || i.hasClass("active") || (o.direction = o.currentItem < n ? "next" : "prev",
                        ...
                        0 >= a && i.hasClass(r + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : e(o.vars.asNavFor).data("flexslider").animating || i.hasClass(r + "active-slide") || (o.direction = o.currentItem < n ? "next" : "prev",
                        o.flexAnimate(n, o.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function() {
                    var t, i, n = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging", a = 1;
                    if (o.controlNavScaffold = e('<ol class="' + r + "control-nav " + r + n + '"></ol>'),
                    o.pagingCount > 1)
                        for (var s = 0; s < o.pagingCount; s++) {
                            if (i = o.slides.eq(s),
                            void 0 === i.attr("data-thumb-alt") && i.attr("data-thumb-alt", ""),
                            altText = "" !== i.attr("data-thumb-alt") ? altText = ' alt="' + i.attr("data-thumb-alt") + '"' : "",
                            t = "thumbnails" === o.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"' + altText + "/>" : '<a href="#">' + a + "</a>",
                    ...
                    g.controlNav.set(),
                    g.controlNav.active(),
                    o.controlNavScaffold.delegate("a, img", p, function(t) {
                        if (t.preventDefault(),
                        "" === d || d === t.type) {
                            var i = e(this)
                              , n = o.controlNav.index(i);
                            i.hasClass(r + "active") || (o.direction = n > o.currentSlide ? "next" : "prev",
                ...
                setupManual: function() {
                    ...
                    g.controlNav.active(),
                    o.controlNav.bind(p, function(t) {
                        if (t.preventDefault(),
                        "" === d || d === t.type) {
                            var i = e(this)
                              , n = o.controlNav.index(i);
                            i.hasClass(r + "active") || (n > o.currentSlide ? o.direction = "next" : o.direction = "prev",
                            o.flexAnimate(n, o.vars.pauseOnAction))
                        }
                        "" === d && (d = t.type),
                        g.setToClearWatchedEvent()
                ...
                update: function(t, i) {
                    o.pagingCount > 1 && "add" === t ? o.controlNavScaffold.append(e('<li><a href="#">' + o.count + "</a></li>")) : 1 === o.pagingCount ? o.controlNavScaffold.find("li").remove() : o.controlNav.eq(i).closest("li").remove(),
                    g.controlNav.set(),
            ...
            directionNav: {
                setup: function() {
                    ...
                    o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (e(o.controlsContainer).append(t),
                    o.directionNav = e("." + r + "direction-nav li a", o.controlsContainer)) : (o.append(t),
                    o.directionNav = e("." + r + "direction-nav li a", o)),
                    g.directionNav.update(),
                    o.directionNav.bind(p, function(t) {
                        t.preventDefault();
                        var i;
                        ("" === d || d === t.type) && (i = e(this).hasClass(r + "next") ? o.getTarget("next") : o.getTarget("prev"),
                        o.flexAnimate(i, o.vars.pauseOnAction)),
                        "" === d && (d = t.type),
                        g.setToClearWatchedEvent()
                    })
            ...
            pausePlay: {
                setup: function() {
                    ...
                    o.controlsContainer ? (o.controlsContainer.append(t),
                    o.pausePlay = e("." + r + "pauseplay a", o.controlsContainer)) : (o.append(t),
                    o.pausePlay = e("." + r + "pauseplay a", o)),
                    g.pausePlay.update(o.vars.slideshow ? r + "pause" : r + "play"),
                    o.pausePlay.bind(p, function(t) {
                        t.preventDefault(),
                        ("" === d || d === t.type) && (e(this).hasClass(r + "pause") ? (o.manualPause = !0,
                        o.manualPlay = !1,
            ...
            touch: function() {
                function e(e) {
                    e.stopPropagation(),
                    o.animating ? e.preventDefault() : (o.pause(),
                    i._gesture.addPointer(e.pointerId),
                    S = 0,
                    p = c ? o.h : o.w,
                    m = Number(new Date),
                    l = f && u && o.animatingTo === o.last ? 0 : f && u ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : f && o.currentSlide === o.last ? o.limit : f ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : u ? (o.last - o.currentSlide + o.cloneOffset) * p : (o.currentSlide + o.cloneOffset) * p)
                }
                function t(e) {
                    e.stopPropagation();
                    ...
                    if (t) {
                        ...
                        return S += c ? o : n,
                        d = S,
                        w = c ? Math.abs(S) < Math.abs(-n) : Math.abs(S) < Math.abs(-o),
                        e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                            i._gesture.stop()
                        }) : void ((!w || Number(new Date) - m > 500) && (e.preventDefault(),
                        !h && t.transitions && (t.vars.animationLoop || (d = S / (0 === t.currentSlide && 0 > S || t.currentSlide === t.last && S > 0 ? Math.abs(S) / p + 2 : 1)),
                ...
                var a, r, l, p, d, m, g, v, y, w = !1, b = 0, x = 0, S = 0;
                s ? (i.style.msTouchAction = "none",
                i._gesture = new MSGesture,
                i._gesture.target = i,
                i.addEventListener("MSPointerDown", e, !1),
                i._slider = o,
                i.addEventListener("MSGestureChange", t, !1),
                i.addEventListener("MSGestureEnd", n, !1)) : (g = function(e) {
                    o.animating ? e.preventDefault() : (window.navigator.msPointerEnabled || 1 === e.touches.length) && (o.pause(),
                    p = c ? o.h : o.w,
                    m = Number(new Date),
                    b = e.touches[0].pageX,
                    x = e.touches[0].pageY,
                ...
                v = function(e) {
                    ...
                    x = e.touches[0].pageY,
                    d = c ? a - x : a - b,
                    w = c ? Math.abs(d) < Math.abs(b - r) : Math.abs(d) < Math.abs(x - r);
                    var t = 500;
                    (!w || Number(new Date) - m > t) && (e.preventDefault(),
                    !h && o.transitions && (o.vars.animationLoop || (d /= 0 === o.currentSlide && 0 > d || o.currentSlide === o.last && d > 0 ? Math.abs(d) / p + 2 : 1),
                    o.setProps(l + d, "setTouch")))
                }
                ,
                y = function(e) {
                    if (i.removeEventListener("touchmove", v, !1),
                    o.animatingTo === o.currentSlide && !w && null !== d) {
                        var t = u ? -d : d
            ...
            resize: function() {
                !o.animating && o.is(":visible") && (f || o.doMath(),
                h ? g.smoothHeight() : f ? (o.slides.width(o.computedW),
                o.update(o.pagingCount),
                o.setProps()) : c ? (o.viewport.height(o.h),
                o.setProps(o.h, "setTotal")) : (o.vars.smoothHeight && g.smoothHeight(),
        ...
        o.flexAnimate = function(t, i, n, a, s) {
            if (o.vars.animationLoop || t === o.currentSlide || (o.direction = t > o.currentSlide ? "next" : "prev"),
            m && 1 === o.pagingCount && (o.direction = o.currentItem < t ? "next" : "prev"),
            !o.animating && (o.canAdvance(t, s) || n) && o.is(":visible")) {
                if (m && a) {
                    var p = e(o.vars.asNavFor).data("flexslider");
                    if (o.atEnd = 0 === t || t === o.count - 1,
                    p.flexAnimate(t, !0, !1, !0, s),
                    o.direction = o.currentItem < t ? "next" : "prev",
                    p.direction = o.direction,
                    Math.ceil((t + 1) / o.visible) - 1 === o.currentSlide || 0 === t)
                        return o.currentItem = t,
                ...
                i && o.pause(),
                o.vars.before(o),
                o.syncExists && !s && g.sync("animate"),
                o.vars.controlNav && g.controlNav.active(),
                f || o.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"),
                o.atEnd = 0 === t || t === o.last,
                o.vars.directionNav && g.directionNav.update(),
                t === o.last && (o.vars.end(o),
                ...
                h)
                    ...
                    f ? (d = o.vars.itemMargin,
                    y = (o.itemW + d) * o.move * o.animatingTo,
                    v = y > o.limit && 1 !== o.visible ? o.limit : y) : v = 0 === o.currentSlide && t === o.count - 1 && o.vars.animationLoop && "next" !== o.direction ? u ? (o.count + o.cloneOffset) * w : 0 : o.currentSlide === o.last && 0 === t && o.vars.animationLoop && "prev" !== o.direction ? u ? 0 : (o.count + 1) * w : u ? (o.count - 1 - t + o.cloneOffset) * w : (t + o.cloneOffset) * w,
        ...
        o.getTarget = function(e) {
            return o.direction = e,
            "next" === e ? o.currentSlide === o.last ? 0 : o.currentSlide + 1 : 0 === o.currentSlide ? o.last : o.currentSlide - 1
        }
        ,
        o.setProps = function(e, t, i) {
            var n = function() {
                var i = e ? e : (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo
                  , n = function() {
                    if (f)
                        return "setTouch" === t ? e : u && o.animatingTo === o.last ? 0 : u ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : o.animatingTo === o.last ? o.limit : i;
                    switch (t) {
                    case "setTotal":
            ...
            o.transitions && (n = c ? "translate3d(0," + n + ",0)" : "translate3d(" + n + ",0,0)",
        ...
        o.setup = function(t) {
            if (h)
                ...
                o.cloneCount = 0,
                o.cloneOffset = 0,
                u && (n = e.makeArray(o.slides).reverse(),
                o.slides = e(n),
                o.container.empty().append(o.slides))),
                o.vars.animationLoop && !f && (o.cloneCount = 2,
                o.cloneOffset = 1,
                "init" !== t && o.container.find(".clone").remove(),
                o.container.append(g.uniqueID(o.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(g.uniqueID(o.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))),
                o.newSlides = e(o.vars.selector, o),
                i = u ? o.count - 1 - o.currentSlide + o.cloneOffset : o.currentSlide + o.cloneOffset,
                c && !f ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"),
                setTimeout(function() {
                    o.newSlides.css({
                        display: "block"
                    }),
                ...
                }, "init" === t ? 100 : 0)) : (o.container.width(200 * (o.count + o.cloneCount) + "%"),
            ...
            f || o.slides.removeClass(r + "active-slide").eq(o.currentSlide).addClass(r + "active-slide"),
            o.vars.init(o)
        }
        ,
        o.doMath = function() {
            ...
            o.limit = 1 === o.pagingCount ? 0 : o.vars.itemWidth > o.w ? o.itemW * (o.count - 1) + t * (o.count - 1) : (o.itemW + t) * o.count - o.w - t) : (o.itemW = o.w,
            o.itemM = t,
        ...
        o.update = function(e, t) {
            o.doMath(),
            f || (e < o.currentSlide ? o.currentSlide += 1 : e <= o.currentSlide && 0 !== e && (o.currentSlide -= 1),
            o.animatingTo = o.currentSlide),
            o.vars.controlNav && !o.manualControls && ("add" === t && !f || o.pagingCount > o.controlNav.length ? g.controlNav.update("add") : ("remove" === t && !f || o.pagingCount < o.controlNav.length) && (f && o.currentSlide > o.last && (o.currentSlide -= 1,
            o.animatingTo -= 1),
        ...
        o.addSlide = function(t, i) {
            ...
            o.count += 1,
            o.last = o.count - 1,
            c && u ? void 0 !== i ? o.slides.eq(o.count - i).after(n) : o.container.prepend(n) : void 0 !== i ? o.slides.eq(i).before(n) : o.container.append(n),
            o.update(i, "add"),
        ...
        o.removeSlide = function(t) {
            ...
            o.count -= 1,
            o.last = o.count - 1,
            isNaN(t) ? e(t, o.slides).remove() : c && u ? o.slides.eq(o.last).remove() : o.slides.eq(t).remove(),
            o.doMath(),
            o.update(i, "remove"),
            o.slides = e(o.vars.selector + ":not(.clone)", o),
            o.setup(),
    ...
    e.fn.flexslider = function(t) {
        ...
        "object" == typeof t)
            return this.each(function() {
                ...
                t.start && t.start(i)) : void 0 === i.data("flexslider") && new e.flexslider(this,t)
            });
...
function(e, t, i) {
    ...
    function o(t, i) {
        ...
        return e.each(t, function(e, o) {
            return "undefined" == typeof i[e] || t[e] !== i[e] ? (n = !1,
            !1) : void 0
        }),
        n
    }
    ...
    n.prototype = {
        _init: function() {
            ...
            if (i.querySelector) {
                var n = null;
                void 0 === t.$el.data("tooltipster-initialTitle") && (n = t.$el.attr("title"),
                void 0 === n && (n = null),
                t.$el.data("tooltipster-initialTitle", n)),
                null !== t.options.content ? t._content_set(t.options.content) : t._content_set(n);
                var o = t.options.functionInit.call(t.$el, t.$el, t.Content);
                "undefined" != typeof o && t._content_set(o),
                t.$el.removeAttr("title").addClass("tooltipstered"),
                !p && t.options.iconDesktop || p && t.options.iconTouch ? ("string" == typeof t.options.icon ? (t.$elProxy = e('<span class="' + t.options.iconTheme + '"></span>'),
                t.$elProxy.text(t.options.icon)) : t.options.iconCloning ? t.$elProxy = t.options.icon.clone(!0) : t.$elProxy = t.options.icon,
                t.$elProxy.insertAfter(t.$el)) : t.$elProxy = t.$el,
                "hover" == t.options.trigger ? (t.$elProxy.on("mouseenter." + t.namespace, function() {
                    a() && !t.options.touchDevices || (t.mouseIsOverProxy = !0,
                    t._show())
        ...
        _showNow: function(i) {
            ...
            n.options.functionBefore.call(n.$el, n.$el, function() {
                if (n.enabled && null !== n.Content) {
                    ...
                    n.timerHide = null,
                    n.options.onlyOne && e(".tooltipstered").not(n.$el).each(function(t, i) {
                        var n = e(i)
                    ...
                    var o = function() {
                        n.Status = "shown",
                        e.each(n.callbacks.show, function(e, t) {
                            t.call(n.$el)
                        }),
                        n.callbacks.show = []
                    };
                    if ("hidden" !== n.Status) {
                        ...
                        if (n.$tooltip = e('<div class="tooltipster-base ' + n.options.theme + '" style="' + d + " " + c + " " + u + " " + l + '"><div class="tooltipster-content"></div></div>'),
                        r() && n.$tooltip.addClass(s),
                        n._content_insert(),
                        n.$tooltip.appendTo("body"),
                        n.reposition(),
                        n.options.functionReady.call(n.$el, n.$el, n.$tooltip),
                        r() ? (n.$tooltip.addClass(s + "-show"),
                        n.options.speed > 0 && n.$tooltip.delay(n.options.speed),
                        ...
                        n.options.autoClose)
                            ...
                            "hover" == n.options.trigger) {
                                ...
                                n.options.interactive && n.$tooltip.on("click." + n.namespace + " touchstart." + n.namespace, function(e) {
                                    e.stopPropagation()
                                }))
                    }
        ...
        _interval_set: function() {
            ...
            t.checkInterval = setInterval(function() {
                if (0 === e("body").find(t.$el).length || 0 === e("body").find(t.$elProxy).length || "hidden" == t.Status || 0 === e("body").find(t.$tooltip).length)
                    "shown" != t.Status && "appearing" != t.Status || t.hide(),
                    t._interval_cancel();
        ...
        _update: function(e) {
            var t = this;
            t._content_set(e),
            null !== t.Content ? "hidden" !== t.Status && (t._content_insert(),
            t.reposition(),
            t.options.updateAnimation && (r() ? (t.$tooltip.css({
                width: "",
            ...
            setTimeout(function() {
                "hidden" != t.Status && (t.$tooltip.removeClass("tooltipster-content-changing"),
                setTimeout(function() {
        ...
        hide: function(i) {
            ...
            if ("shown" == n.Status || "appearing" == n.Status) {
                ...
                n.options.speed > 0 && n.$tooltip.delay(n.options.speed),
                n.$tooltip.queue(a)) : n.$tooltip.stop().fadeOut(n.options.speed, a)
            } else
                "hidden" == n.Status && o();
            return n
        },
        ...
        content: function(e) {
            return "undefined" == typeof e ? this.Content : (this._update(e),
            this)
        },
        reposition: function() {
            function i() {
            ...
            function n(i, n) {
                s.offset.top - e(t).scrollTop() - p - L - 12 < 0 && n.indexOf("top") > -1 && (O = i),
                s.offset.top + s.dimension.height + p + 12 + L > e(t).scrollTop() + e(t).height() && n.indexOf("bottom") > -1 && (O = i,
                M = s.offset.top - p - L - 12)
            }
            var o = this;
            if (0 !== e("body").find(o.$tooltip).length) {
                ...
                if (o.$elProxy.is("area")) {
                    ...
                    if ("circle" == d) {
                        var g = parseInt(m[0])
                          , v = parseInt(m[1])
                          , y = parseInt(m[2]);
                        s.dimension.height = 2 * y,
                        s.dimension.width = 2 * y,
                        s.offset.top = h + v - y,
                        s.offset.left = f + g - y
                    } else if ("rect" == d) {
                        var g = parseInt(m[0])
                          ...
                          , w = parseInt(m[2])
                          , b = parseInt(m[3]);
                        s.dimension.height = b - v,
                        s.dimension.width = w - g,
                        s.offset.top = h + v,
                        s.offset.left = f + g
                    } else if ("poly" == d) {
                        ...
                        s.dimension.height = C - S,
                        s.dimension.width = T - x,
                        s.offset.top = h + S,
                        s.offset.left = f + x
                    } else
                        s.dimension.height = u.outerHeight(!1),
                        s.dimension.width = u.outerWidth(!1),
                        s.offset.top = h,
                        s.offset.left = f
                }
                var I = 0
                ...
                if ("top" == O) {
                    ...
                    I = s.offset.left + A - _ / 2,
                    M = s.offset.top - p - L - 12,
                    i(),
                    n("bottom", "top")
                }
                if ("top-left" == O && (I = s.offset.left + A,
                M = s.offset.top - p - L - 12,
                i(),
                n("bottom-left", "top-left")),
                "top-right" == O && (I = s.offset.left + s.dimension.width + A - l,
                M = s.offset.top - p - L - 12,
                i(),
                n("bottom-right", "top-right")),
                "bottom" == O) {
                    var _ = s.offset.left + l - (s.offset.left + s.dimension.width);
                    I = s.offset.left - _ / 2 + A,
                    M = s.offset.top + s.dimension.height + L + 12,
                    i(),
                    n("top", "bottom")
                }
                if ("bottom-left" == O && (I = s.offset.left + A,
                M = s.offset.top + s.dimension.height + L + 12,
                i(),
                n("top-left", "bottom-left")),
                "bottom-right" == O && (I = s.offset.left + s.dimension.width + A - l,
                M = s.offset.top + s.dimension.height + L + 12,
                i(),
                n("top-right", "bottom-right")),
                "left" == O) {
                    I = s.offset.left - A - l - 12,
                    z = s.offset.left + A + s.dimension.width + 12;
                    var D = s.offset.top + p - (s.offset.top + s.dimension.height);
                    if (M = s.offset.top - D / 2 - L,
                    0 > I && z + l > r) {
                        var H = 2 * parseFloat(o.$tooltip.css("border-width"))
                          , N = l + I - H;
                        o.$tooltip.css("width", N + "px"),
                        p = o.$tooltip.outerHeight(!1),
                        I = s.offset.left - A - N - 12 - H,
                        D = s.offset.top + p - (s.offset.top + s.dimension.height),
                        M = s.offset.top - D / 2 - L
                    } else
                        0 > I && (I = s.offset.left + A + s.dimension.width + 12,
                        a = "left")
                }
                if ("right" == O) {
                    I = s.offset.left + A + s.dimension.width + 12,
                    z = s.offset.left - A - l - 12;
                    var D = s.offset.top + p - (s.offset.top + s.dimension.height);
                    if (M = s.offset.top - D / 2 - L,
                    I + l > r && 0 > z) {
                        var H = 2 * parseFloat(o.$tooltip.css("border-width"))
                        ...
                        I + l > r && (I = s.offset.left - A - l - 12,
                        a = "right")
                }
                if (o.options.arrow) {
                    var W = "tooltipster-arrow-" + O;
                    if (o.options.arrowColor.length < 1)
                        var B = o.$tooltip.css("background-color");
                    else
                        var B = o.options.arrowColor;
                    if (a ? "left" == a ? (W = "tooltipster-arrow-right",
                    a = "") : "right" == a ? (W = "tooltipster-arrow-left",
                    a = "") : a = "left:" + Math.round(a) + "px;" : a = "",
                    "top" == O || "top-left" == O || "top-right" == O)
                        var j = parseFloat(o.$tooltip.css("border-bottom-width"))
                          , $ = o.$tooltip.css("border-bottom-color");
                    else if ("bottom" == O || "bottom-left" == O || "bottom-right" == O)
                        var j = parseFloat(o.$tooltip.css("border-top-width"))
                          , $ = o.$tooltip.css("border-top-color");
                    else if ("left" == O)
                        var j = parseFloat(o.$tooltip.css("border-right-width"))
                          , $ = o.$tooltip.css("border-right-color");
                    else if ("right" == O)
                        var j = parseFloat(o.$tooltip.css("border-left-width"))
                    ...
                    if (0 !== j) {
                        var V = ""
                          , F = "border-color: " + $ + ";";
                        -1 !== W.indexOf("bottom") ? V = "margin-top: -" + Math.round(j) + "px;" : -1 !== W.indexOf("top") ? V = "margin-bottom: -" + Math.round(j) + "px;" : -1 !== W.indexOf("left") ? V = "margin-right: -" + Math.round(j) + "px;" : -1 !== W.indexOf("right") && (V = "margin-left: -" + Math.round(j) + "px;"),
                        R = '<span class="tooltipster-arrow-border" style="' + V + " " + F + ';"></span>'
                    }
        ...
        destroy: function() {
            ...
            if (1 === i.length) {
                var n = null;
                "previous" === t.options.restoration ? n = t.$el.data("tooltipster-initialTitle") : "current" === t.options.restoration && (n = "string" == typeof t.Content ? t.Content : e("<div></div>").append(t.Content).html()),
                n && t.$el.attr("title", n),
        ...
        option: function(e, t) {
            return "undefined" == typeof t ? this.options[e] : (this.options[e] = t,
            this)
        },
        status: function() {
            return this.Status
    ...
    e.fn[s] = function() {
        ...
        return this.each(function() {
            var i = !1
              ...
              , r = null;
            o ? s ? i = !0 : d && console.log('Tooltipster: one or more tooltips are already attached to this element: ignoring. Use the "multiple" option to attach more tooltips.') : i = !0,
            i && (r = new n(this,t[0]),
            o || (o = []),
            o.push(r.namespace),
            e(this).data("tooltipster-ns", o),
            e(this).data(r.namespace, r)),
            a.push(r)
        }),
        s ? a : this
    }
...
!function(e) {
    ...
    if (!e.jQuery) {
        ...
        i.each = function(e, i, n) {
            var o, a = 0, r = e.length, s = t(e);
            if (n) {
                if (s)
                    for (; r > a && (o = i.apply(e[a], n),
                    o !== !1); a++)
                        ;
                else
                    for (a in e)
                ...
                for (; r > a && (o = i.call(e[a], a, e[a]),
                o !== !1); a++)
                    ;
            else
                for (a in e)
                    if (o = i.call(e[a], a, e[a]),
                    o === !1)
                        break;
            return e
        }
        ...
        ,
        i.extend = function() {
            var e, t, n, o, a, r, s = arguments[0] || {}, l = 1, p = arguments.length, d = !1;
            ...
            l--); p > l; l++)
                if (null != (a = arguments[l]))
                    for (o in a)
                        e = s[o],
                        n = a[o],
                        s !== n && (d && n && (i.isPlainObject(n) || (t = i.isArray(n))) ? (t ? (t = !1,
                        r = e && i.isArray(e) ? e : []) : r = e && i.isPlainObject(e) ? e : {},
                        s[o] = i.extend(d, r, n)) : void 0 !== n && (s[o] = n));
            return s
        }
        ,
        i.queue = function(e, n, o) {
            ...
            if (e) {
                n = (n || "fx") + "queue";
                var r = i.data(e, n);
                return o ? (!r || i.isArray(o) ? r = i.data(e, n, a(o)) : r.push(o),
                r) : r || []
            }
        }
        ,
...
function(e) {
    ...
    return function(e, t, i, n) {
        ...
        function l(e, i, n, o) {
            ...
            function f(t) {
                for (var i = 0, o = 1, a = w - 1; o != a && T[o] <= t; ++o)
                    i += b;
                --o;
            ...
            var T = x ? new Float32Array(w) : new Array(w)
              ...
              , E = function(t) {
                return C || h(),
                e === i && n === o ? t : 0 === t ? 0 : 1 === t ? 1 : l(f(t), i, o)
            };
        ...
        function p(e, t) {
            var i = e;
            return m.isString(e) ? w.Easings[e] || (i = !1) : i = m.isArray(e) && 1 === e.length ? s.apply(null, e) : m.isArray(e) && 2 === e.length ? b.apply(null, e.concat([t])) : m.isArray(e) && 4 === e.length ? l.apply(null, e) : !1,
            i === !1 && (i = w.Easings[w.defaults.easing] ? w.defaults.easing : y),
            i
        }
        function d(e) {
            if (e) {
                    ...
                    if (w.State.calls[a]) {
                        ...
                        for (var v = Math.min((t - f) / p.duration, 1), y = 0, b = l.length; b > y; y++) {
                            ...
                            if (r(C)) {
                                ...
                                for (var P in S)
                                    if ("element" !== P) {
                                        var I, z = S[P], M = m.isString(z.easing) ? w.Easings[z.easing] : z.easing;
                                        if (1 === v)
                                            I = z.endValue;
                                        else {
                                            var L = z.endValue - z.startValue;
                                            if (I = z.startValue + L * M(v, p, L),
                                            !h && I === z.currentValue)
                                                continue
                                        }
                                        if (z.currentValue = I,
                                        "tween" === P)
                                            ...
                                            x.Hooks.registered[P] && (r(C).rootPropertyValueCache[A] = x.Normalizations.registered[A] ? x.Normalizations.registered[A]("extract", null, _[1]) : _[1]),
                                            "transform" === _[0] && (E = !0)
                                        }
                                    }
                                p.mobileHA && r(C).transformCache.translate3d === n && (r(C).transformCache.translate3d = "(0px, 0px, 0px)",
                                E = !0),
                                E && x.flushTransformCache(C)
                            }
                        }
                        p.display !== n && "none" !== p.display && (w.State.calls[a][2].display = !1),
                        p.visibility !== n && "hidden" !== p.visibility && (w.State.calls[a][2].visibility = !1),
                        p.progress && p.progress.call(s[1], s[1], v, Math.max(0, f + p.duration - t), f, g),
                        1 === v && c(a)
                    }
            }
        ...
        function c(e, t) {
            ...
            for (var i = w.State.calls[e][0], o = w.State.calls[e][1], a = w.State.calls[e][2], s = w.State.calls[e][4], l = !1, p = 0, d = i.length; d > p; p++) {
                var c = i[p].element;
                if (t || a.loop || ("none" === a.display && x.setPropertyValue(c, "display", a.display),
                "hidden" === a.visibility && x.setPropertyValue(c, "visibility", a.visibility)),
                a.loop !== !0 && (u.queue(c)[1] === n || !/\.velocityQueueEntryFlag/i.test(u.queue(c)[1])) && r(c)) {
                    r(c).isAnimating = !1,
                    ...
                    u.each(x.Lists.transforms3D, function(e, t) {
                        ...
                        r(c).transformCache[t] !== n && new RegExp("^\\(" + i + "[^.]").test(o) && (f = !0,
                        delete r(c).transformCache[t])
                    }),
                    a.mobileHA && (f = !0,
                    delete r(c).transformCache.translate3d),
                    f && x.flushTransformCache(c),
                    x.Values.removeClass(c, "velocity-animating")
                }
                if (!t && a.complete && !a.loop && p === d - 1)
                    try {
                        a.complete.call(o, o)
                    } catch (h) {
                        setTimeout(function() {
                ...
                s && a.loop !== !0 && s(o),
                r(c) && a.loop === !0 && !t && (u.each(r(c).tweensContainer, function(e, t) {
        ...
        var b = function() {
            ...
            return function n(e, t, o) {
                ...
                a = null !== o,
                a ? (d = n(e, t),
                r = d / o * u) : r = u; s = i(s || l, r),
                p.push(1 + s.x),
                d += 16,
                Math.abs(s.x) > c && Math.abs(s.v) > c; )
                    ;
                return a ? function(e) {
        ...
        var x = w.CSS = {
            ...
            Hooks: {
                ...
                extractValue: function(e, t) {
                    ...
                    if (i) {
                        ...
                        t.toString().match(x.RegEx.valueSplit)[o]
                    }
                    return t
                },
                        ...
                        !function() {
                            ...
                            x.Normalizations.registered[t] = function(e, i, o) {
                                ...
                                case "inject":
                                    ...
                                    case "scal":
                                    case "scale":
                                        w.State.isAndroid && r(i).transformCache[t] === n && 1 > o && (o = 1),
                                        a = !/(\d)$/i.test(o);
                                        break;
                                    case "skew":
                                        a = !/(deg|\d)$/i.test(o);
                                    ...
                                    return a || (r(i).transformCache[t] = "(" + o + ")"),
                            ...
                            x.Normalizations.registered[t] = function(e, i, o) {
                                ...
                                case "extract":
                                    ...
                                    if (x.RegEx.wrappedValueAlreadyExtracted.test(o))
                                        ...
                                        /^[A-z]+$/i.test(o) ? r = s[o] !== n ? s[o] : s.black : x.RegEx.isHex.test(o) ? r = "rgb(" + x.Values.hexToRgb(o).join(" ") + ")" : /^rgba?\(/i.test(o) || (r = s.black),
                                        a = (r || o).toString().match(x.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                    }
            ...
            Names: {
                ...
                SVGAttribute: function(e) {
                    ...
                    return (f || w.State.isAndroid && !w.State.isChrome) && (t += "|transform"),
                ...
                prefixCheck: function(e) {
                    ...
                    for (var t = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = t.length; n > i; i++) {
                        ...
                        m.isString(w.State.prefixElement.style[o]))
                            return w.State.prefixMatches[e] = o,
                            [o, !0]
                    }
                    return [e, !1]
                }
            ...
            getPropertyValue: function(e, i, o, a) {
                function s(e, i) {
                    ...
                    if (8 >= f)
                        ...
                        var p = !1;
                        if (/^(width|height)$/.test(i) && 0 === x.getPropertyValue(e, "display") && (p = !0,
                        ...
                        var h;
                        h = r(e) === n ? t.getComputedStyle(e, null) : r(e).computedStyle ? r(e).computedStyle : r(e).computedStyle = t.getComputedStyle(e, null),
                ...
                if (x.Hooks.registered[i]) {
                    var p = i
                      , d = x.Hooks.getRoot(p);
                    o === n && (o = x.getPropertyValue(e, x.Names.prefixCheck(d)[0])),
                    x.Normalizations.registered[d] && (o = x.Normalizations.registered[d]("extract", e, o)),
                    l = x.Hooks.extractValue(p, o)
                } else if (x.Normalizations.registered[i]) {
                    var c, h;
                    c = x.Normalizations.registered[i]("name", e),
                    "transform" !== c && (h = s(e, x.Names.prefixCheck(c)[0]),
            ...
            setPropertyValue: function(e, i, n, o, a) {
                ...
                if ("scroll" === i)
                    ...
                    s = "transform",
                    n = r(e).transformCache[i];
                else {
                    if (x.Hooks.registered[i]) {
                        var l = i
                          , p = x.Hooks.getRoot(i);
                        o = o || x.getPropertyValue(e, p),
                    ...
                    8 >= f)
                        ...
                        r(e) && r(e).isSVG && x.Names.SVGAttribute(i) ? e.setAttribute(i, n) : e.style[s] = n;
        ...
        w.hook = function(e, t, i) {
            ...
            u.each(e, function(e, a) {
                if (r(a) === n && w.init(a),
                i === n)
                    o === n && (o = w.CSS.getPropertyValue(a, t));
                else {
                    var s = w.CSS.setPropertyValue(a, t, i);
                    "transform" === s[0] && w.CSS.flushTransformCache(a),
                    o = s
                }
            }),
            o
            ...
            function o() {
                function e() {
                    function e(e, t) {
                        ...
                        !m.isArray(e[1]) && /^[\d-]/.test(e[1]) || m.isFunction(e[1]) || x.RegEx.isHex.test(e[1]) ? r = e[1] : (m.isString(e[1]) && !x.RegEx.isHex.test(e[1]) || m.isArray(e[1])) && (o = t ? e[1] : p(e[1], s.duration),
                        e[2] !== n && (r = e[2]))) : i = e,
                        t || (o = o || s.easing),
                        m.isFunction(i) && (i = i.call(a, C, T)),
                        m.isFunction(r) && (r = r.call(a, C, T)),
                        [i || 0, o, r]
                    }
                    function c(e, t) {
                        var i, n;
                    ...
                    function f() {
                        ...
                        if (o && n)
                            ...
                            w.init(p),
                            e.myParent.appendChild(p),
                            u.each(["overflow", "overflowX", "overflowY"], function(e, t) {
                                w.CSS.setPropertyValue(p, t, "hidden")
                            }),
                            w.CSS.setPropertyValue(p, "position", e.position),
                            w.CSS.setPropertyValue(p, "fontSize", e.fontSize),
                            w.CSS.setPropertyValue(p, "boxSizing", "content-box"),
                            u.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function(e, t) {
                                w.CSS.setPropertyValue(p, t, s + "%")
                            }),
                            w.CSS.setPropertyValue(p, "paddingLeft", s + "em"),
                            l.percentToPxWidth = _.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(p, "width", null, !0)) || 1) / s,
                            l.percentToPxHeight = _.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(p, "height", null, !0)) || 1) / s,
                            l.emToPx = _.lastEmToPx = (parseFloat(x.getPropertyValue(p, "paddingLeft")) || 1) / s,
                            e.myParent.removeChild(p)
                        }
                        return null === _.remToPx && (_.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16),
                        null === _.vwToPx && (_.vwToPx = parseFloat(t.innerWidth) / 100,
                        _.vhToPx = parseFloat(t.innerHeight) / 100),
                        l.remToPx = _.remToPx,
                        l.vwToPx = _.vwToPx,
                        l.vhToPx = _.vhToPx,
                        w.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), a),
                        l
                    }
                    if (s.begin && 0 === C)
                        try {
                    ...
                    if ("scroll" === I) {
                        var b, S, E, k = /^x$/i.test(s.axis) ? "Left" : "Top", z = parseFloat(s.offset) || 0;
                        s.container ? m.isWrapped(s.container) || m.isNode(s.container) ? (s.container = s.container[0] || s.container,
                        b = s.container["scroll" + k],
                        E = b + u(a).position()[k.toLowerCase()] + z) : s.container = null : (b = w.State.scrollAnchor[w.State["scrollProperty" + k]],
                        S = w.State.scrollAnchor[w.State["scrollProperty" + ("Left" === k ? "Top" : "Left")]],
                        E = u(a).offset()[k.toLowerCase()] + z),
                        l = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: b,
                        ...
                        if (!r(a).tweensContainer)
                            return void u.dequeue(a, s.queue);
                        ...
                        for (var L in M)
                            if ("element" !== L) {
                                ...
                                M[L].endValue = A,
                                m.isEmptyObject(y) || (M[L].easing = s.easing),
                                w.debug && console.log("reverse tweensContainer (" + L + "): " + JSON.stringify(M[L]), a)
                            }
                        l = M
                    } else if ("start" === I) {
                        var M;
                        r(a).tweensContainer && r(a).isAnimating === !0 && (M = r(a).tweensContainer),
                        u.each(g, function(t, i) {
                        ...
                        for (var O in g) {
                            ...
                            if (r(a).isSVG || "tween" === j || x.Names.prefixCheck(j)[1] !== !1 || x.Normalizations.registered[j] !== n) {
                                (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(O) && !B && 0 !== N && (B = 0),
                                s._cacheValues && M && M[O] ? (B === n && (B = M[O].endValue + M[O].unitType),
                                $ = r(a).rootPropertyValueCache[j]) : x.Hooks.registered[O] ? B === n ? ($ = x.getPropertyValue(a, j),
                                B = x.getPropertyValue(a, O, $)) : $ = x.Hooks.templates[j][1] : B === n && (B = x.getPropertyValue(a, O));
                                var R, V, F, q = !1;
                                if (R = c(O, B),
                                B = R[0],
                                F = R[1],
                                R = c(O, N),
                                N = R[0].replace(/^([+-\/*])=/, function(e, t) {
                                    return q = t,
                                    ""
                                }),
                                V = R[1],
                                B = parseFloat(B) || 0,
                                N = parseFloat(N) || 0,
                                "%" === V && (/^(fontSize|lineHeight)$/.test(O) ? (N /= 100,
                                V = "em") : /^scale/.test(O) ? (N /= 100,
                                V = "") : /(Red|Green|Blue)$/i.test(O) && (N = N / 100 * 255,
                                V = "")),
                                /[\/*]/.test(q))
                                    V = F;
                                else if (F !== V && 0 !== B)
                    ...
                    r(a).opts = s),
                    r(a).isAnimating = !0,
                    C === T - 1 ? (w.State.calls.push([D, h, s, null, P.resolver]),
                    w.State.isTicking === !1 && (w.State.isTicking = !0,
                    d())) : C++)
                }
                var o, a = this, s = u.extend({}, w.defaults, y), l = {};
                switch (r(a) === n && w.init(a),
                parseFloat(s.delay) && s.queue !== !1 && u.queue(a, s.queue, function(e) {
                ...
                w.mock !== !1 && (w.mock === !0 ? s.duration = s.delay = 1 : (s.duration *= parseFloat(w.mock) || 1,
                s.delay *= parseFloat(w.mock) || 1)),
                s.easing = p(s.easing, s.duration),
                ...
                "auto" === s.display && (s.display = w.CSS.Values.getDisplayType(a))),
                ...
                s.queue === !1 ? s.delay ? setTimeout(e, s.delay) : e() : u.queue(a, s.queue, function(t, i) {
                    return i === !0 ? (P.promise && P.resolver(h),
            ...
            h = a(h)) {
                ...
                if (!/^(stop|finish|finishAll)$/i.test(g) && !u.isPlainObject(y)) {
                    ...
                    for (var k = E; k < arguments.length; k++)
                        m.isArray(arguments[k]) || !/^(fast|normal|slow)$/i.test(arguments[k]) && !/^\d/.test(arguments[k]) ? m.isString(arguments[k]) || m.isArray(arguments[k]) ? y.easing = arguments[k] : m.isFunction(arguments[k]) && (y.complete = arguments[k]) : y.duration = arguments[k]
                }
                var P = {
                    promise: null,
                    resolver: null,
                ...
                case "stop":
                    u.each(h, function(e, t) {
                        ...
                        "finishAll" !== g || y !== !0 && !m.isString(y) || (u.each(u.queue(t, m.isString(y) ? y : ""), function(e, t) {
                            m.isFunction(t) && t()
                        }),
                    ...
                    return u.each(w.State.calls, function(e, t) {
                        t && u.each(t[1], function(i, o) {
                            ...
                            return a === !0 || t[2].queue === a || y === n && t[2].queue === !1 ? void u.each(h, function(i, n) {
                                ...
                                u.queue(n, m.isString(y) ? y : "", [])),
                                "stop" === g ? (r(n) && r(n).tweensContainer && a !== !1 && u.each(r(n).tweensContainer, function(e, t) {
                    ...
                    if (!u.isPlainObject(g) || m.isEmptyObject(g)) {
                        if (m.isString(g) && w.Redirects[g]) {
                            var M = u.extend({}, y)
                              , L = M.duration
                              , A = M.delay || 0;
                            return M.backwards === !0 && (h = u.extend(!0, [], h).reverse()),
                            u.each(h, function(e, t) {
                                parseFloat(M.stagger) ? M.delay = A + parseFloat(M.stagger) * e : m.isFunction(M.stagger) && (M.delay = A + M.stagger.call(t, e, T)),
                                M.drag && (M.duration = parseFloat(L) || (/^(callout|transition)/.test(g) ? 1e3 : v),
                                M.duration = Math.max(M.duration * (M.backwards ? 1 - e / T : (e + 1) / T), .75 * M.duration, 200)),
                                w.Redirects[g].call(t, t, M || {}, e, T, h, P.promise ? P : n)
                            }),
                            e()
                        }
                        var O = "Velocity: First argument (" + g + ") was not a property map, a known action, or a registered redirect. Aborting.";
                        return P.promise ? P.rejecter(new Error(O)) : console.log(O),
                        e()
                    }
                    I = "start"
                }
                ...
                M.loop)
                    for (var N = 0; H > N; N++) {
                        ...
                        N === H - 1 && (W.display = M.display,
                        W.visibility = M.visibility,
                        W.complete = M.complete),
                        S(h, "reverse", W)
                    }
                return e()
            }
...
function() {
    ...
    this.WOW = function() {
        ...
        o.prototype.vendorSet = function(e, t) {
            ...
            for (i in t)
                ...
                n.push(function() {
                    ...
                    n = r.length; n > t; t++)
                        a = r[t],
                        s.push(e["" + a + i.charAt(0).toUpperCase() + i.substr(1)] = o);
                    return s
                }
                .call(this));
            return n
        ...
        o.prototype.vendorCSS = function(e, t) {
            var i, o, a, r, s, l;
            for (s = n(e),
            r = s.getPropertyCSSValue(t),
            a = this.vendors,
            i = 0,
            o = a.length; o > i; i++)
                l = a[i],
                r = r || s.getPropertyCSSValue("-" + l + "-" + t);
            return r
        }
        ,
...
!function() {
    ...
    var t, i = function(e, n) {
        ...
        function p(e) {
            ...
            if (0 !== i) {
                if (w.params.mousewheelInvert && (i = -i),
                w.params.freeMode) {
                    var o = w.getWrapperTranslate() + i * w.params.mousewheelSensitivity
                      , a = w.isBeginning
                      , r = w.isEnd;
                    if (o >= w.minTranslate() && (o = w.minTranslate()),
                    o <= w.maxTranslate() && (o = w.maxTranslate()),
                    w.setWrapperTransition(0),
                    w.setWrapperTranslate(o),
                    w.updateProgress(),
                    w.updateActiveIndex(),
                    (!a && w.isBeginning || !r && w.isEnd) && w.updateClasses(),
        ...
        for (var v in u)
            if ("undefined" == typeof n[v])
                ...
                for (var y in u[v])
                    "undefined" == typeof n[v][y] && (n[v][y] = u[v][y]);
        var w = this;
        if (w.params = n,
        w.originalParams = h,
        w.classNames = [],
        "undefined" != typeof t && "undefined" != typeof Dom7 && (t = Dom7),
        ("undefined" != typeof t || (t = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (w.$ = t,
        ...
        0 !== w.container.length)) {
            ...
            w.support.flexbox || (w.classNames.push("swiper-container-no-flexbox"),
            ...
            w.classNames.push("swiper-container-3d")) : w.params.effect = "slide"),
            ...
            w.params.spaceBetween = 0,
            w.params.setWrapperSize = !1,
            "undefined" == typeof f && (w.params.virtualTranslate = !0)),
            ...
            "bullets" === w.params.paginationType && w.params.paginationClickable ? w.paginationContainer.addClass("swiper-pagination-clickable") : w.params.paginationClickable = !1,
            w.paginationContainer.addClass("swiper-pagination-" + w.params.paginationType)),
            ...
            ,
            w.params.grabCursor && (w.container[0].style.cursor = "move",
            w.container[0].style.cursor = "-webkit-grab",
            w.container[0].style.cursor = "-moz-grab",
            w.container[0].style.cursor = "grab"),
            w.imagesToLoad = [],
            w.imagesLoaded = 0,
            w.loadImage = function(e, t, i, n, o) {
                function a() {
                    o && o()
                }
                var r;
                e.complete && n ? a() : t ? (r = new window.Image,
                r.onload = a,
                r.onerror = a,
                i && (r.srcset = i),
                t && (r.src = t)) : a()
            ...
            w.preloadImages = function() {
                ...
                for (var t = 0; t < w.imagesToLoad.length; t++)
                    w.loadImage(w.imagesToLoad[t], w.imagesToLoad[t].currentSrc || w.imagesToLoad[t].getAttribute("src"), w.imagesToLoad[t].srcset || w.imagesToLoad[t].getAttribute("srcset"), !0, e)
            }
            ,
            ...
            w.updateSlidesSize = function() {
                ...
                w.slidesGrid = [],
                w.slidesSizesGrid = [];
                var e, t = w.params.spaceBetween, i = -w.params.slidesOffsetBefore, n = 0, a = 0;
                if ("undefined" != typeof w.size) {
                    ...
                    var r;
                    w.params.slidesPerColumn > 1 && (r = Math.floor(w.slides.length / w.params.slidesPerColumn) === w.slides.length / w.params.slidesPerColumn ? w.slides.length : Math.ceil(w.slides.length / w.params.slidesPerColumn) * w.params.slidesPerColumn,
                    "auto" !== w.params.slidesPerView && "row" === w.params.slidesPerColumnFill && (r = Math.max(r, w.params.slidesPerView * w.params.slidesPerColumn)));
                    var s, l = w.params.slidesPerColumn, p = r / l, d = p - (w.params.slidesPerColumn * p - w.slides.length);
                    for (e = 0; e < w.slides.length; e++) {
                        s = 0;
                        var c = w.slides.eq(e);
                        if (w.params.slidesPerColumn > 1) {
                            var u, f, h;
                            "column" === w.params.slidesPerColumnFill ? (f = Math.floor(e / l),
                            h = e - f * l,
                            (f > d || f === d && h === l - 1) && ++h >= l && (h = 0,
                            f++),
                            u = f + h * r / l,
                            c.css({
                        ...
                        "none" !== c.css("display") && ("auto" === w.params.slidesPerView ? (s = w.isHorizontal() ? c.outerWidth(!0) : c.outerHeight(!0),
                        w.params.roundLengths && (s = o(s))) : (s = (w.size - (w.params.slidesPerView - 1) * t) / w.params.slidesPerView,
                        w.params.roundLengths && (s = o(s)),
                        w.isHorizontal() ? w.slides[e].style.width = s + "px" : w.slides[e].style.height = s + "px"),
                        w.slides[e].swiperSlideSize = s,
                        w.slidesSizesGrid.push(s),
                        w.params.centeredSlides ? (i = i + s / 2 + n / 2 + t,
                        0 === e && (i = i - w.size / 2 - t),
                        Math.abs(i) < .001 && (i = 0),
                        a % w.params.slidesPerGroup === 0 && w.snapGrid.push(i),
                        w.slidesGrid.push(i)) : (a % w.params.slidesPerGroup === 0 && w.snapGrid.push(i),
                        w.slidesGrid.push(i),
                        i = i + s + t),
                        w.virtualSize += s + t,
                        n = s,
                    ...
                    w.params.slidesPerColumn > 1 && (w.virtualSize = (s + w.params.spaceBetween) * r,
                    ...
                    w.params.centeredSlides)) {
                        ...
                        e = 0; e < w.snapGrid.length; e++)
                            w.snapGrid[e] < w.virtualSize + w.snapGrid[0] && m.push(w.snapGrid[e]);
                        w.snapGrid = m
                    }
                    if (!w.params.centeredSlides) {
                        for (m = [],
                        e = 0; e < w.snapGrid.length; e++)
                            w.snapGrid[e] <= w.virtualSize - w.size && m.push(w.snapGrid[e]);
                        w.snapGrid = m,
            ...
            w.updateSlidesProgress = function(e) {
                if ("undefined" == typeof e && (e = w.translate || 0),
                0 !== w.slides.length) {
            ...
            w.updateActiveIndex = function() {
                ...
                for (t = 0; t < w.slidesGrid.length; t++)
                    "undefined" != typeof w.slidesGrid[t + 1] ? n >= w.slidesGrid[t] && n < w.slidesGrid[t + 1] - (w.slidesGrid[t + 1] - w.slidesGrid[t]) / 2 ? e = t : n >= w.slidesGrid[t] && n < w.slidesGrid[t + 1] && (e = t + 1) : n >= w.slidesGrid[t] && (e = t);
            ...
            w.updateClasses = function() {
                ...
                if (w.params.loop && 0 === n.length && w.slides.eq(-1).addClass(w.params.slidePrevClass),
                w.paginationContainer && w.paginationContainer.length > 0) {
                    ...
                    if (w.params.loop ? (o = Math.ceil((w.activeIndex - w.loopedSlides) / w.params.slidesPerGroup),
                    o > w.slides.length - 1 - 2 * w.loopedSlides && (o -= w.slides.length - 2 * w.loopedSlides),
                    o > a - 1 && (o -= a),
                    0 > o && "bullets" !== w.params.paginationType && (o = a + o)) : o = "undefined" != typeof w.snapIndex ? w.snapIndex : w.activeIndex || 0,
                    ...
                    }) : w.bullets.eq(o).addClass(w.params.bulletActiveClass)),
                    "fraction" === w.params.paginationType && (w.paginationContainer.find("." + w.params.paginationCurrentClass).text(o + 1),
                    ...
                    "progress" === w.params.paginationType) {
                        ...
                        w.isHorizontal() || (l = r,
                        s = 1),
                        w.paginationContainer.find("." + w.params.paginationProgressbarClass).transform("translate3d(0,0,0) scaleX(" + s + ") scaleY(" + l + ")").transition(w.params.speed)
                    }
                    "custom" === w.params.paginationType && w.params.paginationCustomRender && (w.paginationContainer.html(w.params.paginationCustomRender(w, o + 1, a)),
            ...
            w.updatePagination = function() {
                if (w.params.pagination && w.paginationContainer && w.paginationContainer.length > 0) {
                    ...
                    if ("bullets" === w.params.paginationType) {
                        for (var t = w.params.loop ? Math.ceil((w.slides.length - 2 * w.loopedSlides) / w.params.slidesPerGroup) : w.snapGrid.length, i = 0; t > i; i++)
                            e += w.params.paginationBulletRender ? w.params.paginationBulletRender(i, w.params.bulletClass) : "<" + w.params.paginationElement + ' class="' + w.params.bulletClass + '"></' + w.params.paginationElement + ">";
            ...
            w.update = function(e) {
                function t() {
                    n = Math.min(Math.max(w.translate, w.maxTranslate()), w.minTranslate()),
                ...
                e) {
                    ...
                    w.params.freeMode ? (t(),
                    w.params.autoHeight && w.updateAutoHeight()) : (i = ("auto" === w.params.slidesPerView || w.params.slidesPerView > 1) && w.isEnd && !w.params.centeredSlides ? w.slideTo(w.slides.length - 1, 0, !1, !0) : w.slideTo(w.activeIndex, 0, !1, !0),
                    i || t())
                } else
            ...
            w.onResize = function(e) {
                ...
                if (w.params.freeMode) {
                    ...
                    w.updateClasses(),
                    n = ("auto" === w.params.slidesPerView || w.params.slidesPerView > 1) && w.isEnd && !w.params.centeredSlides ? w.slideTo(w.slides.length - 1, 0, !1, !0) : w.slideTo(w.activeIndex, 0, !1, !0);
            ...
            w.initEvents = function(e) {
                var t = e ? "off" : "on"
                  ...
                  , r = !!w.params.nested;
                w.browser.ie ? (o[i](w.touchEvents.start, w.onTouchStart, !1),
                a[i](w.touchEvents.move, w.onTouchMove, r),
                a[i](w.touchEvents.end, w.onTouchEnd, !1)) : (w.support.touch && (o[i](w.touchEvents.start, w.onTouchStart, !1),
                o[i](w.touchEvents.move, w.onTouchMove, r),
                o[i](w.touchEvents.end, w.onTouchEnd, !1)),
                !n.simulateTouch || w.device.ios || w.device.android || (o[i]("mousedown", w.onTouchStart, !1),
                document[i]("mousemove", w.onTouchMove, r),
                document[i]("mouseup", w.onTouchEnd, !1))),
                window[i]("resize", w.onResize),
                w.params.nextButton && w.nextButton && w.nextButton.length > 0 && (w.nextButton[t]("click", w.onClickNext),
                w.params.a11y && w.a11y && w.nextButton[t]("keydown", w.a11y.onEnterKey)),
                w.params.prevButton && w.prevButton && w.prevButton.length > 0 && (w.prevButton[t]("click", w.onClickPrev),
                ...
                (w.params.preventClicks || w.params.preventClicksPropagation) && o[i]("click", w.preventClicks, !0)
            }
            ,
            ...
            w.updateClickedSlide = function(e) {
                var i = r(e, "." + w.params.slideClass)
                  , n = !1;
                if (i)
                    for (var o = 0; o < w.slides.length; o++)
                        w.slides[o] === i && (n = !0);
                if (!i || !n)
                ...
                w.params.slideToClickedSlide && void 0 !== w.clickedIndex && w.clickedIndex !== w.activeIndex) {
                    ...
                    if (w.params.loop) {
                        if (w.animating)
                            return;
                        a = t(w.clickedSlide).attr("data-swiper-slide-index"),
                        w.params.centeredSlides ? s < w.loopedSlides - w.params.slidesPerView / 2 || s > w.slides.length - w.loopedSlides + w.params.slidesPerView / 2 ? (w.fixLoop(),
                        s = w.wrapper.children("." + w.params.slideClass + '[data-swiper-slide-index="' + a + '"]:not(.swiper-slide-duplicate)').eq(0).index(),
                        setTimeout(function() {
                            w.slideTo(s)
                        }, 0)) : w.slideTo(s) : s > w.slides.length - w.params.slidesPerView ? (w.fixLoop(),
                        s = w.wrapper.children("." + w.params.slideClass + '[data-swiper-slide-index="' + a + '"]:not(.swiper-slide-duplicate)').eq(0).index(),
                        setTimeout(function() {
                            w.slideTo(s)
                        }, 0)) : w.slideTo(s)
            ...
            ;
            var S, T, C, E, k, P, I, z, M, L, A = "input, select, textarea, button", O = Date.now(), _ = [];
            w.animating = !1,
            w.touches = {
                startX: 0,
                startY: 0,
                    ...
                    if (!w.params.swipeHandler || r(e, w.params.swipeHandler)) {
                        ...
                        if (!(w.device.ios && w.params.iOSEdgeSwipeDetection && i <= w.params.iOSEdgeSwipeThreshold)) {
                            ...
                            "touchstart" !== e.type) {
                                var o = !0;
                                t(e.target).is(A) && (o = !1),
                                document.activeElement && t(document.activeElement).is(A) && document.activeElement.blur(),
                                o && e.preventDefault()
                            }
            ...
            w.onTouchMove = function(e) {
                ...
                !D || "mousemove" !== e.type) {
                    ...
                    if (w.params.onlyExternal)
                        ...
                        void (S && (w.touches.startX = w.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
                        w.touches.startY = w.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY,
                        E = Date.now()));
                    if (D && document.activeElement && e.target === document.activeElement && t(e.target).is(A))
                        return T = !0,
                        void (w.allowClick = !1);
                    ...
                    !(e.targetTouches && e.targetTouches.length > 1)) {
                        ...
                        if (k && w.emit("onTouchMoveOpposite", w, e),
                        "undefined" == typeof H && w.browser.ieTouch && (w.touches.currentX !== w.touches.startX || w.touches.currentY !== w.touches.startY) && (H = !0),
                        S) {
                            if (k)
                                return void (S = !1);
                            if (H || !w.browser.ieTouch) {
                                ...
                                o *= w.params.touchRatio,
                                w.rtl && (o = -o),
                                w.swipeDirection = o > 0 ? "prev" : "next",
                                P = o + I;
                                var a = !0;
                                if (o > 0 && P > w.minTranslate() ? (a = !1,
                                w.params.resistance && (P = w.minTranslate() - 1 + Math.pow(-w.minTranslate() + I + o, w.params.resistanceRatio))) : 0 > o && P < w.maxTranslate() && (a = !1,
                                w.params.resistance && (P = w.maxTranslate() + 1 - Math.pow(w.maxTranslate() - I - o, w.params.resistanceRatio))),
                                a && (e.preventedByNestedSwiper = !0),
                                !w.params.allowSwipeToNext && "next" === w.swipeDirection && I > P && (P = I),
                                !w.params.allowSwipeToPrev && "prev" === w.swipeDirection && P > I && (P = I),
                                w.params.followFinger) {
                                    if (w.params.threshold > 0) {
                                        if (!(Math.abs(o) > w.params.threshold || z))
                                            return void (P = I);
                                        if (!z)
                                            return z = !0,
                                    ...
                                    w.params.freeMode && (0 === _.length && _.push({
            ...
            w.onTouchEnd = function(e) {
                ...
                C = !1,
                S) {
                    w.params.grabCursor && T && S && (w.container[0].style.cursor = "move",
                    w.container[0].style.cursor = "-webkit-grab",
                    w.container[0].style.cursor = "-moz-grab",
                    w.container[0].style.cursor = "grab");
                    var i = Date.now()
                    ...
                    w.emit("onTap", w, e),
                    300 > n && i - O > 300 && (M && clearTimeout(M),
                    ...
                    300 > n && 300 > i - O && (M && clearTimeout(M),
                    w.emit("onDoubleTap", w, e))),
                    O = Date.now(),
                    setTimeout(function() {
                        w && (w.allowClick = !0)
                    }, 0),
                    !S || !T || !w.swipeDirection || 0 === w.touches.diff || P === I)
                        return void (S = T = !1);
                    S = T = !1;
                    var o;
                    if (o = w.params.followFinger ? w.rtl ? w.translate : -w.translate : -P,
                    w.params.freeMode) {
                        if (o < -w.minTranslate())
                        ...
                        if (w.params.freeModeMomentum) {
                            ...
                            var p = 1e3 * w.params.freeModeMomentumRatio
                              ...
                              , c = w.translate + d;
                            w.rtl && (c = -c);
                            var u, f = !1, h = 20 * Math.abs(w.velocity) * w.params.freeModeMomentumBounceRatio;
                            if (c < w.maxTranslate())
                                w.params.freeModeMomentumBounce ? (c + w.maxTranslate() < -h && (c = w.maxTranslate() - h),
                                u = w.maxTranslate(),
                                f = !0,
                                L = !0) : c = w.maxTranslate();
                            else if (c > w.minTranslate())
                                w.params.freeModeMomentumBounce ? (c - w.minTranslate() > h && (c = w.minTranslate() + h),
                                u = w.minTranslate(),
                                f = !0,
                                L = !0) : c = w.minTranslate();
                                ...
                                c = Math.abs(w.snapGrid[m] - c) < Math.abs(w.snapGrid[m - 1] - c) || "next" === w.swipeDirection ? w.snapGrid[m] : w.snapGrid[m - 1],
                                w.rtl || (c = -c)
                            }
                            if (0 !== w.velocity)
                                p = w.rtl ? Math.abs((-c - w.translate) / w.velocity) : Math.abs((c - w.translate) / w.velocity);
                            else if (w.params.freeModeSticky)
                                return void w.slideReset();
                            w.params.freeModeMomentumBounce && f ? (w.updateProgress(u),
                    ...
                    for (v = 0; v < w.slidesGrid.length; v += w.params.slidesPerGroup)
                        "undefined" != typeof w.slidesGrid[v + w.params.slidesPerGroup] ? o >= w.slidesGrid[v] && o < w.slidesGrid[v + w.params.slidesPerGroup] && (y = v,
                        b = w.slidesGrid[v + w.params.slidesPerGroup] - w.slidesGrid[v]) : o >= w.slidesGrid[v] && (y = v,
                    ...
                    if (n > w.params.longSwipesMs) {
                        if (!w.params.longSwipes)
                            return void w.slideTo(w.activeIndex);
                        "next" === w.swipeDirection && (x >= w.params.longSwipesRatio ? w.slideTo(y + w.params.slidesPerGroup) : w.slideTo(y)),
                        "prev" === w.swipeDirection && (x > 1 - w.params.longSwipesRatio ? w.slideTo(y + w.params.slidesPerGroup) : w.slideTo(y))
                    } else {
            ...
            w.slideTo = function(e, t, i, n) {
                ...
                w.params.autoplay && w.autoplaying && (n || !w.params.autoplayDisableOnInteraction ? w.pauseAutoplay(t) : w.stopAutoplay()),
                w.updateProgress(o);
                for (var a = 0; a < w.slidesGrid.length; a++)
                    -Math.floor(100 * o) >= Math.floor(100 * w.slidesGrid[a]) && (e = a);
                return !w.params.allowSwipeToNext && o < w.translate && o < w.minTranslate() ? !1 : !w.params.allowSwipeToPrev && o > w.translate && o > w.maxTranslate() && (w.activeIndex || 0) !== e ? !1 : ("undefined" == typeof t && (t = w.params.speed),
                w.previousIndex = w.activeIndex || 0,
                w.activeIndex = e,
                w.rtl && -o === w.translate || !w.rtl && o === w.translate ? (w.params.autoHeight && w.updateAutoHeight(),
                w.updateClasses(),
                "slide" !== w.params.effect && w.setWrapperTranslate(o),
                !1) : (w.updateClasses(),
                w.onTransitionStart(i),
                0 === t ? (w.setWrapperTranslate(o),
                w.setWrapperTransition(0),
                w.onTransitionEnd(i)) : (w.setWrapperTranslate(o),
            ...
            w.slideNext = function(e, t, i) {
                return w.params.loop ? w.animating ? !1 : (w.fixLoop(),
            ...
            w.setWrapperTranslate = function(e, t, i) {
                var n = 0
                  , a = 0
                  , r = 0;
                w.isHorizontal() ? n = w.rtl ? -e : e : a = e,
                w.params.roundLengths && (n = o(n),
                a = o(a)),
                w.params.virtualTranslate || (w.support.transforms3d ? w.wrapper.transform("translate3d(" + n + "px, " + a + "px, " + r + "px)") : w.wrapper.transform("translate(" + n + "px, " + a + "px)")),
                w.translate = w.isHorizontal() ? n : a;
                var s, l = w.maxTranslate() - w.minTranslate();
                s = 0 === l ? 0 : (e - w.minTranslate()) / l,
            ...
            w.getTranslate = function(e, t) {
                ...
                w.params.virtualTranslate ? w.rtl ? -w.translate : w.translate : (o = window.getComputedStyle(e, null),
                window.WebKitCSSMatrix ? (n = o.transform || o.webkitTransform,
                n.split(",").length > 6 && (n = n.split(", ").map(function(e) {
                    return e.replace(",", ".")
                }).join(", ")),
                a = new window.WebKitCSSMatrix("none" === n ? "" : n)) : (a = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
                i = a.toString().split(",")),
            ...
            w.createLoop = function() {
                ...
                for (e.each(function(i, a) {
                    var r = t(this);
                    i < w.loopedSlides && o.push(a),
                    i < e.length && i >= e.length - w.loopedSlides && n.push(a),
                    r.attr("data-swiper-slide-index", i)
                }),
                i = 0; i < o.length; i++)
                    w.wrapper.append(t(o[i].cloneNode(!0)).addClass(w.params.slideDuplicateClass));
                for (i = n.length - 1; i >= 0; i--)
                    w.wrapper.prepend(t(n[i].cloneNode(!0)).addClass(w.params.slideDuplicateClass))
            }
            ,
            ...
            w.effects = {
                    ...
                    setTranslate: function() {
                        for (var e = 0; e < w.slides.length; e++) {
                            ...
                            var o = i[0].swiperSlideOffset
                              ...
                              , l = -o
                              , p = 0;
                            if (w.isHorizontal() ? w.rtl && (r = -r) : (p = l,
                            l = 0,
                            s = -r,
                            r = 0),
                            i[0].style.zIndex = -Math.abs(Math.round(n)) + w.slides.length,
                            w.params.flip.slideShadows) {
                                ...
                                i.append(d)),
                                0 === c.length && (c = t('<div class="swiper-slide-shadow-' + (w.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                i.append(c)),
                ...
                cube: {
                    setTranslate: function() {
                        var e, i = 0;
                        w.params.cube.shadow && (w.isHorizontal() ? (e = w.wrapper.find(".swiper-cube-shadow"),
                        ...
                        for (var n = 0; n < w.slides.length; n++) {
                            ...
                            n % 4 === 0 ? (l = 4 * -r * w.size,
                            d = 0) : (n - 1) % 4 === 0 ? (l = 0,
                            d = 4 * -r * w.size) : (n - 2) % 4 === 0 ? (l = w.size + 4 * r * w.size,
                            d = w.size) : (n - 3) % 4 === 0 && (l = -w.size,
                            d = 3 * w.size + 4 * w.size * r),
                            w.rtl && (l = -l),
                            w.isHorizontal() || (p = l,
                            l = 0);
                            var c = "rotateX(" + (w.isHorizontal() ? 0 : -a) + "deg) rotateY(" + (w.isHorizontal() ? a : 0) + "deg) translate3d(" + l + "px, " + p + "px, " + d + "px)";
                            if (1 >= s && s > -1 && (i = 90 * n + 90 * s,
                            w.rtl && (i = 90 * -n - 90 * s)),
                            o.transform(c),
                            w.params.cube.slideShadows) {
                                ...
                                0 === u.length && (u = t('<div class="swiper-slide-shadow-' + (w.isHorizontal() ? "left" : "top") + '"></div>'),
                                o.append(u)),
                                0 === f.length && (f = t('<div class="swiper-slide-shadow-' + (w.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                o.append(f)),
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var e = w.translate, i = w.isHorizontal() ? -e + w.width / 2 : -e + w.height / 2, n = w.isHorizontal() ? w.params.coverflow.rotate : -w.params.coverflow.rotate, o = w.params.coverflow.depth, a = 0, r = w.slides.length; r > a; a++) {
                            ...
                            if (s.transform(g),
                            s[0].style.zIndex = -Math.abs(Math.round(d)) + 1,
                            w.params.coverflow.slideShadows) {
                                ...
                                0 === v.length && (v = t('<div class="swiper-slide-shadow-' + (w.isHorizontal() ? "left" : "top") + '"></div>'),
                                s.append(v)),
                                0 === y.length && (y = t('<div class="swiper-slide-shadow-' + (w.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                s.append(y)),
            ...
            w.lazy = {
                ...
                loadImageInSlide: function(e, i) {
                    ...
                    0 !== w.slides.length)) {
                        ...
                        !n.hasClass("swiper-lazy") || n.hasClass("swiper-lazy-loaded") || n.hasClass("swiper-lazy-loading") || (o = o.add(n[0])),
                ...
                load: function() {
                    ...
                    if (w.params.lazyLoadingInPrevNext)
                        if (w.params.slidesPerView > 1 || w.params.lazyLoadingInPrevNextAmount && w.params.lazyLoadingInPrevNextAmount > 1) {
                            ...
                            for (e = w.activeIndex + w.params.slidesPerView; o > e; e++)
                                w.slides[e] && w.lazy.loadImageInSlide(e);
            ...
            w.scrollbar = {
                ...
                setTranslate: function() {
                    if (w.params.scrollbar) {
                        var e, t = w.scrollbar, i = (w.translate || 0,
                        t.dragSize);
                        e = (t.trackSize - t.dragSize) * w.progress,
                        w.rtl && w.isHorizontal() ? (e = -e,
                        e > 0 ? (i = t.dragSize - e,
            ...
            w.controller = {
                ...
                setTranslate: function(e, t) {
                    function n(t) {
                        ...
                        "slide" === w.params.controlBy && (w.controller.getInterpolateFunction(t),
                        a = -w.controller.spline.interpolate(-e)),
                        a && "container" !== w.params.controlBy || (o = (t.maxTranslate() - t.minTranslate()) / (w.maxTranslate() - w.minTranslate()),
                        a = (e - w.minTranslate()) * o + t.minTranslate()),
                ...
                setTransition: function(e, t) {
                    function n(t) {
                        ...
                        t.wrapper.transitionEnd(function() {
                            a && (t.params.loop && "slide" === w.params.controlBy && t.fixLoop(),
                            t.onTransitionEnd())
                        }))
                    }
            ...
            w.disableMousewheelControl = function() {
                return w.mousewheel.event ? (w.container.off(w.mousewheel.event, p),
                !0) : !1
            }
            ,
            w.enableMousewheelControl = function() {
                return w.mousewheel.event ? (w.container.on(w.mousewheel.event, p),
                !0) : !1
            }
            ,
            w.parallax = {
    ...
    for (var n = ["jQuery", "Zepto", "Dom7"], o = 0; o < n.length; o++)
        window[n[o]] && e(window[n[o]]);
    var a;
    ...
    a && ("transitionEnd"in a.fn || (a.fn.transitionEnd = function(e) {
        ...
        var i, n = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], o = this;
        if (e)
...
!function() {
    ...
    function i(e, i) {
        ...
        "undefined" != typeof i && null !== i)
            ...
            if (void 0 !== document.createElement) {
                ...
                n.href = this.path,
                n.pathname = n.pathname.replace(r, t),
    ...
    e.init = function(e) {
        ...
        ;
        e.onload = function() {
            var e, i, o = document.getElementsByTagName("img"), a = [];
            for (e = 0; e < o.length; e += 1)
                i = o[e],
                i.getAttributeNode("data-no-retina") || a.push(new n(i));
            t()
        }
    }
    ,
    ...
    i.prototype.check_2x_variant = function(e) {
        var t, n = this;
        return this.is_external() ? e(!1) : this.perform_check || "undefined" == typeof this.at_2x_path || null === this.at_2x_path ? this.at_2x_path in i.confirmed_paths ? e(!0) : (t = new XMLHttpRequest,
    ...
    n.prototype.swap = function(e) {
        function t() {
            ...
            i.el.setAttribute("src", e)) : setTimeout(t, 5)
        }
...
function(e) {
    e.fn.theiaStickySidebar = function(t) {
        function i(t, i) {
            var o = n(t, i);
            o || (console.log("TST: Body width smaller than options.minWidth. Init is delayed."),
            e(document).scroll(function(t, i) {
                return function(o) {
                    var a = n(t, i);
                    a && e(this).unbind(o)
                }
            }(t, i)),
            e(window).resize(function(t, i) {
                return function(o) {
                    var a = n(t, i);
                    a && e(this).unbind(o)
                }
        ...
        function n(t, i) {
            return t.initialized === !0 ? !0 : e("body").width() < t.minWidth ? !1 : (o(t, i),
            !0)
        }
        function o(t, i) {
            t.initialized = !0,
            e("head").append(e('<style>.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')),
            i.each(function() {
                function i() {
                    o.fixedScrollTop = 0,
                    o.sidebar.css({
                ...
                0 == o.stickySidebar.length && (o.sidebar.find("script").remove(),
                o.stickySidebar = e("<div>").addClass("theiaStickySidebar").append(o.sidebar.children()),
                ...
                0 == r ? (o.stickySidebar.css("padding-bottom", 0),
                ...
                o.onScroll = function(o) {
                    if (o.stickySidebar.is(":visible")) {
                        if (e("body").width() < o.options.minWidth)
                            return void i();
                        if (o.options.disableOnResponsiveLayouts) {
                            var a = o.sidebar.outerWidth("none" == o.sidebar.css("float"));
                            if (a + 50 > o.container.width())
                                return void i()
                        }
                        var r = e(document).scrollTop()
                          , s = "static";
                        if (r >= o.container.offset().top + (o.paddingTop + o.marginTop - o.options.additionalMarginTop)) {
                            var l, p = o.paddingTop + o.marginTop + t.additionalMarginTop, d = o.paddingBottom + o.marginBottom + t.additionalMarginBottom, c = o.container.offset().top, u = o.container.offset().top + n(o.container), f = 0 + t.additionalMarginTop, h = o.stickySidebar.outerHeight() + p + d < e(window).height();
                            ...
                            "fixed" == o.stickySidebar.css("position") && "modern" == o.options.sidebarBehavior && (v += y),
                            "stick-to-top" == o.options.sidebarBehavior && (v = t.additionalMarginTop),
                            "stick-to-bottom" == o.options.sidebarBehavior && (v = l - o.stickySidebar.outerHeight()),
                            v = y > 0 ? Math.min(v, f) : Math.max(v, l - o.stickySidebar.outerHeight()),
                            v = Math.max(v, m),
                            v = Math.min(v, g - o.stickySidebar.outerHeight());
                        ...
                        if ("fixed" == s)
                            ...
                            b.top = r + v - o.sidebar.offset().top - o.stickySidebarPaddingTop - o.stickySidebarPaddingBottom),
...
function(e) {
    e.fn.collagePlus = function(t) {
        function i(t, i, o, a) {
            for (var r = o.padding * (t.length - 1) + t.length * t[0][3], s = o.albumWidth - r, l = s / (i - r), p = r, d = i < o.albumWidth, c = 0; c < t.length; c++) {
                var u = e(t[c][0])
                  ...
                  , m = !!(c < t.length - 1);
                o.allowPartialLastRow === !0 && d === !0 && (f = t[c][1],
                h = t[c][2]),
                p += f,
                !m && p < o.albumWidth && (o.allowPartialLastRow === !0 && d === !0 ? f = f : f += o.albumWidth - p),
                f--;
                var g = u.is("img") ? u : u.find("img");
                g.width(f),
                u.is("img") || u.width(f + t[c][3]),
                g.height(h),
                u.is("img") || u.height(h + t[c][4]),
                n(u, m, o),
                g.one("load", function(e) {
                    return function() {
                        if ("default" == o.effect)
                            e.animate({
                                opacity: "1"
        ...
        function o(t) {
            $img = e(t);
            var i = new Array;
            return i.w = parseFloat($img.css("border-left-width")) + parseFloat($img.css("border-right-width")),
            i.h = parseFloat($img.css("border-top-width")) + parseFloat($img.css("border-bottom-width")),
            i
        }
        return this.each(function() {
            var n = 0
              ...
              , r = 1
              , s = e(this);
            e.fn.collagePlus.defaults.albumWidth = s.width(),
            e.fn.collagePlus.defaults.padding = parseFloat(s.css("padding-left")),
            e.fn.collagePlus.defaults.images = s.children();
            ...
            l.images.each(function(t) {
                ...
                a.push([this, f, h, u.w, u.h]),
                n += f + u.w + l.padding,
                n > l.albumWidth && 0 != a.length && (i(a, n - l.padding, l, r),
                delete n,
                delete a,
                n = 0,
                a = [],
                r += 1),
                l.images.length - 1 == t && 0 != a.length && (i(a, n, l, r),
                delete n,
                delete a,
                n = 0,
                a = [],
    ...
    e.fn.pagepiling = function(o) {
        ...
        function s(t, i) {
            ...
            if (!n.activeSection.is(t)) {
                "undefined" == typeof n.animated && (n.animated = !0),
                "undefined" != typeof n.anchorLink && f(n.anchorLink, n.sectionIndex),
                n.destination.addClass("active").siblings().removeClass("active"),
                n.sectionsToMove = d(n),
                "down" === n.yMovement ? (n.translate3d = W(),
                n.scrolling = "-100%",
                U.css3 || n.sectionsToMove.each(function(t) {
                    t != n.activeSection.index(".pp-section") && e(this).css(u(n.scrolling))
                }),
                n.animateSection = n.activeSection) : (n.translate3d = "translate3d(0px, 0px, 0px)",
                n.scrolling = "0",
                n.animateSection = t),
                e.isFunction(U.onLeave) && U.onLeave.call(this, n.leavingSection, n.sectionIndex + 1, n.yMovement),
                l(n),
                H(n.anchorLink),
        ...
        function v() {
            ...
            if (o.length && o && o !== B) {
                var a;
                a = isNaN(o) ? e(t).find('[data-anchor="' + o + '"]') : e(".pp-section").eq(o - 1),
                s(a)
            }
        }
        function y(e) {
        ...
        function C() {
            $.get(0).addEventListener ? ($.get(0).removeEventListener("mousewheel", b, !1),
            $.get(0).removeEventListener("wheel", b, !1)) : $.get(0).detachEvent("onmousewheel", b)
        }
        function E() {
            $.get(0).addEventListener ? ($.get(0).addEventListener("mousewheel", b, !1),
            $.get(0).addEventListener("wheel", b, !1)) : $.get(0).attachEvent("onmousewheel", b)
        }
        function k() {
            if (V) {
                var e = I();
                $.off("touchstart " + e.down).on("touchstart " + e.down, L),
                $.off("touchmove " + e.move).on("touchmove " + e.move, A)
            }
        }
        function P() {
            if (V) {
        ...
        function A(t) {
            ...
            if (!O(t.target) && M(i)) {
                ...
                !g()) {
                    ...
                    G = a.y,
                    Y = a.x,
                    "horizontal" === U.direction && Math.abs(q - Y) > Math.abs(F - G) ? Math.abs(q - Y) > $.width() / 100 * U.touchSensitivity && (q > Y ? x("down", o) : Y > q && x("up", o)) : Math.abs(F - G) > $.height() / 100 * U.touchSensitivity && (F > G ? x("down", o) : G > F && x("up", o))
                }
            }
        }
        function O(t, i) {
        ...
        function _() {
            ...
            for (var i = 0; i < e(".pp-section").length; i++) {
                var n = "";
                if (U.anchors.length && (n = U.anchors[i]),
        ...
        function D(t, i) {
            ...
            t ? e("#pp-nav").find('a[href="#' + t + '"]').addClass("active") : e("#pp-nav").find("li").eq(i).find("a").addClass("active"))
        }
        function H(t) {
        ...
        function N() {
            ...
            for (var r in a)
                o.style[r] !== n && (o.style[r] = "translate3d(1px,1px,1px)",
                e = i.getComputedStyle(o).getPropertyValue(a[r]));
            return t.body.removeChild(o),
            e !== n && e.length > 0 && "none" !== e
        }
        function W() {
            return "vertical" !== U.direction ? "translate3d(-100%, 0px, 0px)" : "translate3d(0px, -100%, 0px)"
        }
        var B, j = e.fn.pagepiling, $ = e(this), R = 0, V = "ontouchstart"in i || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, F = 0, q = 0, G = 0, Y = 0, X = 600, U = e.extend(!0, {
            direction: "vertical",
            menu: null,
            verticalCentered: !0,
            sectionsColor: [],
        ...
        j.setAllowScrolling = function(e) {
            e ? (j.setMouseWheelScrolling(!0),
            k()) : (j.setMouseWheelScrolling(!1),
            P())
        }
        ,
        ...
        j.moveTo = function(i) {
            var n = "";
            n = isNaN(i) ? e(t).find('[data-anchor="' + i + '"]') : e(".pp-section").eq(i - 1),
            n.length > 0 && s(n)
        }
        ,
        ...
        e(".pp-section").each(function(t) {
            ...
            U.verticalCentered && !e(this).hasClass("pp-scrollable") && a(e(this)),
            Q -= 1
...
!function(e) {
    ...
    t.prototype = {
        init: function() {
            this.options.panel && (this.initStructure(),
            this.attachEvents())
        },
        initStructure: function() {
            ...
            this.fake = e('<div class="' + this.options.fakeBlockClass + '"></div>'),
            this.resizeFlag = !1,
            this.isActive = !1,
            this.scrollPosition = 0,
            this.scrollPositionPrev = 0,
            this.options.fakeBlock && this.fake.insertBefore(this.panel).css({
                display: "none",
                height: this.height
            })
        },
        attachEvents: function() {
            ...
            ,
            i.on("scroll", this.onScrollHandler),
            i.on("resize orientationchange", this.onResizeWindow)
        },
        getTargetOffset: function(t) {
            return "number" == typeof this.options.extraOffset ? t = this.options.extraOffset : "string" == typeof this.options.extraOffset && (t = e(this.options.extraOffset).offset().top + e(this.options.extraOffset).outerHeight()),
            t
        },
        scrollHandler: function() {
            var e = i.scrollTop();
            e > this.offset ? this.isActive || (this.panel.addClass(this.options.slickyClass),
            this.options.fakeBlock && this.fake.show(),
            this.isActive = !0) : this.isActive && (this.panel.removeClass(this.options.slickyClass),
            this.options.fakeBlock && this.fake.hide(),
            this.isActive = !1),
            this.options.scrollClasses && (this.scrollPosition = e,
            this.scrollPosition > this.scrollPositionPrev ? (this.panel.addClass(this.options.scrollBottomClass),
            this.panel.removeClass(this.options.scrollTopClass)) : (this.panel.addClass(this.options.scrollTopClass),
            this.panel.removeClass(this.options.scrollBottomClass)),
            this.scrollPositionPrev = this.scrollPosition)
        },
        windowResize: function() {
            this.options.fakeBlock ? (this.height = this.panel.outerHeight(),
            this.offset = this.getTargetOffset(this.options.extraOffset),
            this.fake.css({
                height: this.height
            })) : this.offset = this.getTargetOffset(this.options.extraOffset),
        ...
        destroy: function() {
            console.log(1),
            this.options.fakeBlock && this.fake.remove(),
            this.resizeFlag = !0,
            ...
            i.off("scroll", this.onScrollHandler),
            i.off("resize", this.onResizeWindow)
        }
    },
    ...
    var t = "animsition"
      , i = {
        init: function(n) {
            ...
            if (!o && n.browser.length > 0 && (!o || !this.length))
            ...
            return a && i.addOverlay.call(this, n),
            ...
            this.each(function() {
                ...
                n.onLoadEvent && r.on("load." + t, function() {
                ...
                s.on("click." + t, n.linkElement, function(t) {
                    t.preventDefault();
                    var n = e(this)
                      , a = n.attr("href");
        ...
        animationCheck: function(i, n, o) {
            ...
            return l || p ? i = i : n && o ? i = r.inClass : !n && o ? i = r.inDuration : n && !o ? i = r.outClass : n || o || (i = r.outDuration),
            i
        },
        "in": function() {
            var n = this
            ...
            c && o.removeClass(c),
            d ? i.inOverlay.call(n, p, l) : i.inDefault.call(n, p, l)
        },
        ...
        inOverlay: function(n, o) {
            ...
            e(r.overlayParentElement).children("." + r.overlayClass).css({
        ...
        out: function(n, o) {
            ...
            r.data(t).outClass = h,
            g ? i.outOverlay.call(a, h, m, o) : i.outDefault.call(a, h, m, o)
        },
...
function() {
    ...
    function t() {
        if (!_ && document.body) {
            ...
            var t = document.body
              ...
              , o = t.scrollHeight;
            if (D = document.compatMode.indexOf("CSS") >= 0 ? i : t,
            C = t,
            e(),
            top != self)
                A = !0;
                ...
                a.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + D.scrollHeight + "px",
            ...
            M.fixedBackground || L || (t.style.backgroundAttachment = "scroll",
        ...
        !j) {
            var r = e === document.body
              , s = function(n) {
                ...
                r ? window.scrollBy(a, l) : (a && (e.scrollLeft += a),
                l && (e.scrollTop += l)),
                t || i || (B = []),
                B.length ? q(s, e, 1e3 / M.frameRate + 1) : j = !1
            };
            q(s, e, 0),
            j = !0
        }
    ...
    function o(e) {
        ...
        var i = e.target
          , o = p(i);
        if (!o || e.defaultPrevented || e.ctrlKey)
            return !0;
        if (m(C, "embed") || m(i, "embed") && /\.pdf/i.test(i.src) || m(C, "object"))
            return !0;
        var a = -e.wheelDeltaX || e.deltaX || 0
          , r = -e.wheelDeltaY || e.deltaY || 0;
        return N && (e.wheelDeltaX && y(e.wheelDeltaX, 120) && (a = -120 * (e.wheelDeltaX / Math.abs(e.wheelDeltaX))),
        e.wheelDeltaY && y(e.wheelDeltaY, 120) && (r = -120 * (e.wheelDeltaY / Math.abs(e.wheelDeltaY)))),
        a || r || (r = -e.wheelDelta || 0),
        1 === e.deltaMode && (a *= 40,
        r *= 40),
        !M.touchpadSupport && v(r) ? !0 : (Math.abs(a) > 1.2 && (a *= M.stepSize / 120),
    ...
    function a(e) {
        ...
        if (o.test(t.nodeName) || m(t, "input") && !a.test(t.type) || m(C, "video") || b(e) || t.isContentEditable || e.defaultPrevented || i)
            return !0;
        if ((m(t, "button") || m(t, "input") && a.test(t.type)) && e.keyCode === W.spacebar)
            return !0;
        var r, l = 0, d = 0, c = p(C), u = c.clientHeight;
    ...
    function b(e) {
        ...
        if (-1 != document.URL.indexOf("www.youtube.com/watch"))
            do
                if (i = t.classList && t.classList.contains("html5-video-controls"))
                    break;
            while (t = t.parentNode);return i
    }
    function x(e) {
        var t, i, n;
        return e *= M.pulseScale,
        1 > e ? t = e - (1 - Math.exp(-e)) : (i = Math.exp(-1),
        e -= 1,
        n = 1 - Math.exp(-e),
        t = i + n * (1 - i)),
        t * M.pulseNormalize
    ...
    function S(e) {
        return e >= 1 ? 1 : 0 >= e ? 0 : (1 == M.pulseNormalize && (M.pulseNormalize /= x(1)),
        x(e))
    }
    function T(e) {
        for (var t in e)
            z.hasOwnProperty(t) && (M[t] = e[t])
    }
    var C, E, k, P, I, z = {
        frameRate: 150,
        animationTime: 400,
        ...
        x: 0,
        y: 0
    }, _ = !1, D = document.documentElement, H = [], N = /^Mac/.test(navigator.platform), W = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
    ...
    }(), G = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, Y = function() {
        var e;
        return function() {
            if (!e) {
                ...
                window.scrollBy(0, 3),
                e = document.body.scrollTop != i ? document.body : document.documentElement,
                window.scrollBy(0, -3),
                document.body.removeChild(t)
            }
            return e
        }
    }(), X = window.navigator.userAgent, U = /Edge/.test(X), Q = /chrome/i.test(X) && !U, K = /safari/i.test(X) && !U, Z = /mobile/i.test(X), J = (Q || K) && !Z;
    "onwheel"in document.createElement("div") ? F = "wheel" : "onmousewheel"in document.createElement("div") && (F = "mousewheel"),
    F && J && (f(F, o),
    f("mousedown", r),
    f("load", t)),
    T.destroy = i,
    window.SmoothScrollOptions && T(window.SmoothScrollOptions),
